...
#SUMB_SUBDIRS       = $(SUBDIR_SRC) $(SUBDIR_PV3) $(SUBDIR_PYTHON)
SUMB_SUBDIRS       = $(SUBDIR_SRC) $(SUBDIR_PYTHON)
...
OSX_INTEL:
	(cd externals/SU_MPI && gmake OSX_INTEL)
	(cd externals/ADT && gmake OSX_INTEL)
	ln -sf config/config.OSX_INTEL.mk config.mk
	gmake sumb

OSX_INTEL_OPENMPI:
	(cd externals/SU_MPI && gmake OSX_INTEL_OPENMPI)
	(cd externals/ADT && gmake OSX_INTEL_OPENMPI)
	ln -sf config/config.OSX_INTEL_OPENMPI.mk config.mk
	gmake sumb
...
WCR_INTEL:
	(cd externals/SU_MPI && gmake WCR_INTEL)
	(cd externals/ADT && gmake WCR_INTEL)
	ln -sf config/config.WCR_INTEL.mk config.mk
	gmake sumb
