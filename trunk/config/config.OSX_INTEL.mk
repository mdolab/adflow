...
#      *              defines the settings for a sequential OSX         *
...
CC_OPTFLAGS     = -O -arch x86_64

#FF90_DEBUGFLAGS = -g -CA -CB -CS -implicitnone -e90 -e95 -DDEBUG_MODE
...
PV3_FLAGS          = -DUSE_PV3
PV3_LINKER_FLAGS   = -L/usr/local/pV3/clients/DARWIN64 -lpV3
PVM3_LINKER_FLAGS  = -L/usr/local/pvm3/lib/DARWIN64 -lgpvm3 -lpvm3
...
#LINKER_FLAGS = $(FF90_OPTFLAGS) -nofor_main -llapack \
	       -L/usr/lib/gcc-lib/i386-redhat-linux/3.3.2 -lg2c
