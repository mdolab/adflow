...
FF90_OPTFLAGS   =  -O1 -r8 #-O1 -r8 #-check all# -O2 -r8 -fpic# -check all #-tpp7 -xW -unroll -ip
...
PYTHON_INCLUDE_DIR = /nobackup/kenway/opt/include/python2.6
NUMPY_ROOT_DIR = /nobackup/kenway/opt/lib/python2.6/site-packages/
