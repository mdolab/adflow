#      ******************************************************************
#      *                                                                *
#      * File:          config.REDHOT_IFC_MYRINET.mk                    *
...
#      *              is that the Myrinet version of mpif90 and mpicc   *
...
EXEC_SUFFIX = _redhot_pg_myrinet
...
FF90 = /usr/local/gm-mpich-pgi5/bin/mpif90
CC   = /usr/local/gm-mpich-pgi5/bin/mpicc
...
CGNS_LINKER_FLAGS  = -L$(HOME)/CGNS2.3/lib -lcgns.LINUX
...
FF90_OPTFLAGS   = -fastsse -tp athlonxp
...
#PVM3_LINKER_FLAGS  = -L/usr/local/pvm3/lib/BEOLIN -lgpvm3 -lpvm3
