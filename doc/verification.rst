...
The cases are run at transonic mach numbers and Reynolds Numbers of ``Re = 5e6``.
Figure 8 of in this paper details drag grid convergence of each of the flow solvers.
...
A NACA 0009 hydrofoil is analyzed at a Reynolds Number of ``Re = 1e6`` and compared to experimental results.
...
Wind Turbines
-------------
Analysis of wind turbines is conducted in this paper :cite:`Madsen2019a`.
...
These results show ADflow consistently overshoots the EllipSys3D results at all wind speeds.
