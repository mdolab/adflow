...
class ADFLOW(AeroSolver):
    ...
    def _getDefaultOptions():
        defOpts = {
            ...
            "sepSensorOffsetOne": [float, 0.0],
            "sepSensorOffsetTwo": [float, 0.0],
            "sepSensorSharpness": [float, 10.0],
            "sepSensorSharpnessOne": [float, 25.0],
            "sepSensorSharpnessTwo": [float, 25.0],
    ...
    def _getOptionMap(self):
        ...
        optionMap = {
            ...
            "sepsensoroffsetone": ["cost", "sepsensoroffsetone"],
            "sepsensorsharpnessone": ["cost", "sepsensorsharpnessone"],
            "sepsensoroffsettwo": ["cost", "sepsensoroffsettwo"],
            "sepsensorsharpnesstwo": ["cost", "sepsensorsharpnesstwo"],
    ...
    def _getObjectivesAndDVs(self):
        ...
        adflowCostFunctions = {
            ...
            "sepsensorarea": self.adflow.constants.costfuncsepsensorarea,
