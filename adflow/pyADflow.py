...
class ADFLOW(AeroSolver):
    ...
    def _getDefaultOptions():
        defOpts = {
            ...
            "adjointSolver": [str, ["GMRES", "TFQMR", "Richardson", "BCGS", "IBCGS", "GCRODR", "BGMRES", "BGCRODR"]],
            "adjointMaxIter": [int, 500],
            "adjointSubspaceSize": [int, 100],
            "adjointRecycleSize": [int, 5],
            "avoidRedundantAdjoints": [bool, False],
            "adjointHPDDMDeflationTol": [float, 0.0],
    ...
    def _getOptionMap(self):
        ...
        optionMap = {
            ...
            "adjointrecyclesize": ["adjoint", "adjrecyclesize"],
            "adjointhpddmdeflationtol": ["adjoint", "adjhpddmdeflationtol"],
