...
class ADFLOW(AeroSolver):
    ...
    def _getDefaultOptions():
        defOpts = {
            ...
            'limiter':[str, ['vanAlbada', 'minmod', 'noLimiter']],
            ...
            'turbulenceModel':[str, ['SA', 'SAE', 'k omega Wilcox', 'k omega modified', 'k tau', 'Menter SST', 'v2f']],
    ...
    def _getOptionMap(self):
        ...
        optionMap = {
            ...
            'limiter':{'vanalbada':self.adflow.constants.vanalbeda,
