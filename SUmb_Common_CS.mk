...
INPUT_DIR   = $(SUMB_DIR)/src_cs/inputParam
TURB_DIR   = $(SUMB_DIR)/src_cs/turbulence

SUMB_MODDIR = $(SUMB_DIR)/mod_cs
SUMB_OBJDIR = $(SUMB_DIR)/obj_cs
SUMB_BINDIR = $(SUMB_DIR)/bin
SUMB_LIBDIR = $(SUMB_DIR)/lib_cs
...
FF90_ALL_FLAGS   = $(FF90_LOCAL_FLAGS) $(CGNS_INCLUDE_FLAGS) \
		   $(FF90_FLAGS) $(ADDITIONAL_FF90_FLAGS) \
