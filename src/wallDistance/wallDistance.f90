...
!
       ...
       if(componentsBreakDown .and. .not. wallFunctions) wallDistanceNeeded =.false. ! eran-cbd
...
!
!--------eran-des: for DES calculations
!
            if(applyDES  .and. level == 1 )call determineDistanceDes(level, sps) 
!
!--------eran-des: end DES section
