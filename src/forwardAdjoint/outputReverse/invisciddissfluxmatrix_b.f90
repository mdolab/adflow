   ...
   REAL(kind=realtype) :: dp1b, dp2b, ddwb, fsb
   ...
   CALL POPREAL8(abv4)
   tempb49 = gm1*abv4b
   drb = alphaavg*tempb49 - unavg*abv5b + lam3*fsb
   drub = drub + sx*abv5b - uavg*tempb49
   drvb = drvb + sy*abv5b - vavg*tempb49
   drwb = drwb + sz*abv5b - wavg*tempb49
   gm1b = (alphaavg*dr-uavg*dru-vavg*drv+dre-wavg*drw)*abv4b
   alphaavgb = dr*tempb49
   uavgb = uavgb - dru*tempb49
   vavgb = vavgb - drv*tempb49
   dreb = dreb + tempb49
   wavgb = wavgb - drw*tempb49
   gm53b = -(drk*abv4b)
   drkb = -(gm53*abv4b)
   CALL POPREAL8(abv3)
   abv1b = abv3b
   ...
   tempb48 = half*alphaavgb
   tempb47 = ovgm1*havgb
   aavgb = aavgb - one*ovaavgb/aavg**2
   IF (a2avg .EQ. 0.0_8) THEN
   a2avgb = tempb47 - one*ova2avgb/a2avg**2
   ELSE
   a2avgb = aavgb/(2.0*SQRT(a2avg)) + tempb47 - one*ova2avgb/&
   &             a2avg**2
   END IF
   uavgb = uavgb + 2*uavg*tempb48 + sx*unavgb
   vavgb = vavgb + 2*vavg*tempb48 + sy*unavgb
   wavgb = wavgb + 2*wavg*tempb48 + sz*unavgb
   CALL POPREAL8(aavg)
   ovgm1b = (a2avg-gm53*kavg)*havgb
   gm53b = gm53b - kavg*tempb47
   kavgb = -(gm53*tempb47)
   ...
   tempb45 = half*a2avgb/temp63
   tempb46 = half*a2avgb/temp64
   gammab(i, j, k+1) = gammab(i, j, k+1) + temp62*tempb45
   pb(i, j, k+1) = pb(i, j, k+1) + temp61*tempb45
   wb(i, j, k+1, irho) = wb(i, j, k+1, irho) - temp61*temp62*&
   &           tempb45/temp63
   gammab(i, j, k) = gammab(i, j, k) + p(i, j, k)*tempb46
   pb(i, j, k) = pb(i, j, k) + gamma(i, j, k)*tempb46
   ...
   tempb44 = -(dis4*drkb)
   dis2b = ddw*drkb
   ddwb = dis2*drkb - three*tempb44
   dis4b = -((temp57*temp58-temp59*temp60-three*ddw)*drkb)
   wb(i, j, k+2, irho) = wb(i, j, k+2, irho) + temp58*tempb44
   wb(i, j, k+2, itu1) = wb(i, j, k+2, itu1) + temp57*tempb44
   wb(i, j, k-1, irho) = wb(i, j, k-1, irho) - temp60*tempb44
   wb(i, j, k-1, itu1) = wb(i, j, k-1, itu1) - temp59*tempb44
   ...
   ddwb = dis2*dreb - three*tempb39
   dis4b = dis4b - (w(i, j, k+2, irhoe)-w(i, j, k-1, irhoe)-three&
   &           *ddw)*dreb
   wb(i, j, k+2, irhoe) = wb(i, j, k+2, irhoe) + tempb39
   wb(i, j, k-1, irhoe) = wb(i, j, k-1, irhoe) - tempb39
   CALL POPREAL8(ddw)
   ...
   ddwb = dis2*drwb - three*tempb40
   dis4b = dis4b - (temp53*temp54-temp55*temp56-three*ddw)*drwb
   wb(i, j, k+2, irho) = wb(i, j, k+2, irho) + temp54*tempb40
   wb(i, j, k+2, ivz) = wb(i, j, k+2, ivz) + temp53*tempb40
   wb(i, j, k-1, irho) = wb(i, j, k-1, irho) - temp56*tempb40
   wb(i, j, k-1, ivz) = wb(i, j, k-1, ivz) - temp55*tempb40
   CALL POPREAL8(ddw)
   ...
   ddwb = dis2*drvb - three*tempb41
   dis4b = dis4b - (temp49*temp50-temp51*temp52-three*ddw)*drvb
   wb(i, j, k+2, irho) = wb(i, j, k+2, irho) + temp50*tempb41
   wb(i, j, k+2, ivy) = wb(i, j, k+2, ivy) + temp49*tempb41
   wb(i, j, k-1, irho) = wb(i, j, k-1, irho) - temp52*tempb41
   wb(i, j, k-1, ivy) = wb(i, j, k-1, ivy) - temp51*tempb41
   CALL POPREAL8(ddw)
   ...
   ddwb = dis2*drub - three*tempb42
   dis4b = dis4b - (temp45*temp46-temp47*temp48-three*ddw)*drub
   wb(i, j, k+2, irho) = wb(i, j, k+2, irho) + temp46*tempb42
   wb(i, j, k+2, ivx) = wb(i, j, k+2, ivx) + temp45*tempb42
   wb(i, j, k-1, irho) = wb(i, j, k-1, irho) - temp48*tempb42
   wb(i, j, k-1, ivx) = wb(i, j, k-1, ivx) - temp47*tempb42
   ...
   tempb43 = -(dis4*drb)
   dis2b = dis2b + ddw*drb
   ddwb = dis2*drb - three*tempb43
   dis4b = dis4b - (w(i, j, k+2, irho)-w(i, j, k-1, irho)-three*&
   &           ddw)*drb
   wb(i, j, k+2, irho) = wb(i, j, k+2, irho) + tempb43
   wb(i, j, k-1, irho) = wb(i, j, k-1, irho) - tempb43
   CALL POPREAL8(ddw)
   ...
   tempb36 = x6b/temp44
   tempb37 = -((p(i, j, k+2)-two*p(i, j, k+1)+p(i, j, k))*tempb36&
   &           /temp44)
   tempb38 = omega*tempb37
   pb(i, j, k+2) = pb(i, j, k+2) + tempb38 + tempb36
   pb(i, j, k+1) = pb(i, j, k+1) + two*tempb38 - two*tempb36
   pb(i, j, k) = pb(i, j, k) + tempb38 + tempb36
   abs6b = oneminomega*tempb37
   abs12b = oneminomega*tempb37
   plimb = plimb + tempb37
   CALL POPCONTROL1B(branch)
   IF (branch .EQ. 0) THEN
   CALL POPREAL8(abs12)
   ...
   tempb33 = x5b/temp43
   tempb34 = -((p(i, j, 2)-two*p(i, j, 1)+p(i, j, 0))*tempb33/&
   &         temp43)
   tempb35 = omega*tempb34
   pb(i, j, 2) = pb(i, j, 2) + tempb35 + tempb33
   pb(i, j, 1) = pb(i, j, 1) + two*tempb35 - two*tempb33
   pb(i, j, 0) = pb(i, j, 0) + tempb35 + tempb33
   abs5b = oneminomega*tempb34
   abs11b = oneminomega*tempb34
   plimb = plimb + tempb34
   CALL POPCONTROL1B(branch)
   IF (branch .EQ. 0) THEN
   CALL POPREAL8(abs11)
   ...
   CALL POPREAL8(abv4)
   tempb32 = gm1*abv4b
   drb = alphaavg*tempb32 - unavg*abv5b + lam3*fsb
   drub = drub + sx*abv5b - uavg*tempb32
   drvb = drvb + sy*abv5b - vavg*tempb32
   drwb = drwb + sz*abv5b - wavg*tempb32
   gm1b = (alphaavg*dr-uavg*dru-vavg*drv+dre-wavg*drw)*abv4b
   alphaavgb = dr*tempb32
   uavgb = uavgb - dru*tempb32
   vavgb = vavgb - drv*tempb32
   dreb = dreb + tempb32
   wavgb = wavgb - drw*tempb32
   gm53b = -(drk*abv4b)
   drkb = -(gm53*abv4b)
   CALL POPREAL8(abv3)
   abv1b = abv3b
   ...
   END IF
   alphaavgb = alphaavgb + havgb
   tempb31 = half*alphaavgb
   tempb30 = ovgm1*havgb
   aavgb = aavgb - one*ovaavgb/aavg**2
   IF (a2avg .EQ. 0.0_8) THEN
   a2avgb = tempb30 - one*ova2avgb/a2avg**2
   ELSE
   a2avgb = aavgb/(2.0*SQRT(a2avg)) + tempb30 - one*ova2avgb/&
   &             a2avg**2
   END IF
   uavgb = uavgb + 2*uavg*tempb31 + sx*unavgb
   vavgb = vavgb + 2*vavg*tempb31 + sy*unavgb
   wavgb = wavgb + 2*wavg*tempb31 + sz*unavgb
   CALL POPREAL8(aavg)
   ovgm1b = (a2avg-gm53*kavg)*havgb
   gm53b = gm53b - kavg*tempb30
   kavgb = -(gm53*tempb30)
   gm1b = gm1b - one*ovgm1b/gm1**2
   CALL POPREAL8(area)
   CALL POPREAL8(sz)
   ...
   tempb28 = half*a2avgb/temp41
   tempb29 = half*a2avgb/temp42
   gammab(i, j+1, k) = gammab(i, j+1, k) + temp40*tempb28
   pb(i, j+1, k) = pb(i, j+1, k) + temp39*tempb28
   wb(i, j+1, k, irho) = wb(i, j+1, k, irho) - temp39*temp40*&
   &           tempb28/temp41
   gammab(i, j, k) = gammab(i, j, k) + p(i, j, k)*tempb29
   pb(i, j, k) = pb(i, j, k) + gamma(i, j, k)*tempb29
   wb(i, j, k, irho) = wb(i, j, k, irho) - gamma(i, j, k)*p(i, j&
   &           , k)*tempb29/temp42
   ...
   tempb27 = -(dis4*drkb)
   dis2b = ddw*drkb
   ddwb = dis2*drkb - three*tempb27
   dis4b = -((temp35*temp36-temp37*temp38-three*ddw)*drkb)
   wb(i, j+2, k, irho) = wb(i, j+2, k, irho) + temp36*tempb27
   wb(i, j+2, k, itu1) = wb(i, j+2, k, itu1) + temp35*tempb27
   wb(i, j-1, k, irho) = wb(i, j-1, k, irho) - temp38*tempb27
   wb(i, j-1, k, itu1) = wb(i, j-1, k, itu1) - temp37*tempb27
   ...
   tempb22 = -(dis4*dreb)
   dis2b = dis2b + ddw*dreb
   ddwb = dis2*dreb - three*tempb22
   dis4b = dis4b - (w(i, j+2, k, irhoe)-w(i, j-1, k, irhoe)-three&
   &           *ddw)*dreb
   wb(i, j+2, k, irhoe) = wb(i, j+2, k, irhoe) + tempb22
   wb(i, j-1, k, irhoe) = wb(i, j-1, k, irhoe) - tempb22
   CALL POPREAL8(ddw)
   ...
   tempb23 = -(dis4*drwb)
   dis2b = dis2b + ddw*drwb
   ddwb = dis2*drwb - three*tempb23
   dis4b = dis4b - (temp31*temp32-temp33*temp34-three*ddw)*drwb
   wb(i, j+2, k, irho) = wb(i, j+2, k, irho) + temp32*tempb23
   wb(i, j+2, k, ivz) = wb(i, j+2, k, ivz) + temp31*tempb23
   wb(i, j-1, k, irho) = wb(i, j-1, k, irho) - temp34*tempb23
   wb(i, j-1, k, ivz) = wb(i, j-1, k, ivz) - temp33*tempb23
   CALL POPREAL8(ddw)
   ...
   tempb24 = -(dis4*drvb)
   dis2b = dis2b + ddw*drvb
   ddwb = dis2*drvb - three*tempb24
   dis4b = dis4b - (temp27*temp28-temp29*temp30-three*ddw)*drvb
   wb(i, j+2, k, irho) = wb(i, j+2, k, irho) + temp28*tempb24
   wb(i, j+2, k, ivy) = wb(i, j+2, k, ivy) + temp27*tempb24
   wb(i, j-1, k, irho) = wb(i, j-1, k, irho) - temp30*tempb24
   wb(i, j-1, k, ivy) = wb(i, j-1, k, ivy) - temp29*tempb24
   CALL POPREAL8(ddw)
   ...
   tempb25 = -(dis4*drub)
   dis2b = dis2b + ddw*drub
   ddwb = dis2*drub - three*tempb25
   dis4b = dis4b - (temp23*temp24-temp25*temp26-three*ddw)*drub
   wb(i, j+2, k, irho) = wb(i, j+2, k, irho) + temp24*tempb25
   wb(i, j+2, k, ivx) = wb(i, j+2, k, ivx) + temp23*tempb25
   wb(i, j-1, k, irho) = wb(i, j-1, k, irho) - temp26*tempb25
   wb(i, j-1, k, ivx) = wb(i, j-1, k, ivx) - temp25*tempb25
   ...
   tempb26 = -(dis4*drb)
   dis2b = dis2b + ddw*drb
   ddwb = dis2*drb - three*tempb26
   dis4b = dis4b - (w(i, j+2, k, irho)-w(i, j-1, k, irho)-three*&
   &           ddw)*drb
   wb(i, j+2, k, irho) = wb(i, j+2, k, irho) + tempb26
   wb(i, j-1, k, irho) = wb(i, j-1, k, irho) - tempb26
   CALL POPREAL8(ddw)
   ...
   tempb19 = x4b/temp22
   tempb20 = -((p(i, j+2, k)-two*p(i, j+1, k)+p(i, j, k))*tempb19&
   &           /temp22)
   tempb21 = omega*tempb20
   pb(i, j+2, k) = pb(i, j+2, k) + tempb21 + tempb19
   pb(i, j+1, k) = pb(i, j+1, k) + two*tempb21 - two*tempb19
   pb(i, j, k) = pb(i, j, k) + tempb21 + tempb19
   abs4b = oneminomega*tempb20
   abs10b = oneminomega*tempb20
   plimb = plimb + tempb20
   CALL POPCONTROL1B(branch)
   IF (branch .EQ. 0) THEN
   CALL POPREAL8(abs10)
   ...
   tempb16 = x3b/temp21
   tempb17 = -((p(i, 2, k)-two*p(i, 1, k)+p(i, 0, k))*tempb16/&
   &         temp21)
   tempb18 = omega*tempb17
   pb(i, 2, k) = pb(i, 2, k) + tempb18 + tempb16
   pb(i, 1, k) = pb(i, 1, k) + two*tempb18 - two*tempb16
   pb(i, 0, k) = pb(i, 0, k) + tempb18 + tempb16
   abs3b = oneminomega*tempb17
   abs9b = oneminomega*tempb17
   plimb = plimb + tempb17
   CALL POPCONTROL1B(branch)
   IF (branch .EQ. 0) THEN
   CALL POPREAL8(abs9)
   ...
   CALL POPREAL8(abv4)
   tempb15 = gm1*abv4b
   drb = alphaavg*tempb15 - unavg*abv5b + lam3*fsb
   drub = drub + sx*abv5b - uavg*tempb15
   drvb = drvb + sy*abv5b - vavg*tempb15
   drwb = drwb + sz*abv5b - wavg*tempb15
   gm1b = (alphaavg*dr-uavg*dru-vavg*drv+dre-wavg*drw)*abv4b
   alphaavgb = dr*tempb15
   uavgb = uavgb - dru*tempb15
   vavgb = vavgb - drv*tempb15
   dreb = dreb + tempb15
   wavgb = wavgb - drw*tempb15
   gm53b = -(drk*abv4b)
   drkb = -(gm53*abv4b)
   CALL POPREAL8(abv3)
   abv1b = abv3b
   ...
   END IF
   alphaavgb = alphaavgb + havgb
   tempb14 = half*alphaavgb
   tempb13 = ovgm1*havgb
   aavgb = aavgb - one*ovaavgb/aavg**2
   IF (a2avg .EQ. 0.0_8) THEN
   a2avgb = tempb13 - one*ova2avgb/a2avg**2
   ELSE
   a2avgb = aavgb/(2.0*SQRT(a2avg)) + tempb13 - one*ova2avgb/&
   &             a2avg**2
   END IF
   uavgb = uavgb + 2*uavg*tempb14 + sx*unavgb
   vavgb = vavgb + 2*vavg*tempb14 + sy*unavgb
   wavgb = wavgb + 2*wavg*tempb14 + sz*unavgb
   CALL POPREAL8(aavg)
   ovgm1b = (a2avg-gm53*kavg)*havgb
   gm53b = gm53b - kavg*tempb13
   kavgb = -(gm53*tempb13)
   gm1b = gm1b - one*ovgm1b/gm1**2
   CALL POPREAL8(area)
   CALL POPREAL8(sz)
   ...
   tempb11 = half*a2avgb/temp19
   tempb12 = half*a2avgb/temp20
   gammab(i+1, j, k) = gammab(i+1, j, k) + temp18*tempb11
   pb(i+1, j, k) = pb(i+1, j, k) + temp17*tempb11
   wb(i+1, j, k, irho) = wb(i+1, j, k, irho) - temp17*temp18*&
   &           tempb11/temp19
   gammab(i, j, k) = gammab(i, j, k) + p(i, j, k)*tempb12
   pb(i, j, k) = pb(i, j, k) + gamma(i, j, k)*tempb12
   wb(i, j, k, irho) = wb(i, j, k, irho) - gamma(i, j, k)*p(i, j&
   &           , k)*tempb12/temp20
