   ...
   x6b = -dp2b
   END IF
   temp44 = plim + omega*(p(i, j, k+2)+two*p(i, j, k+1)+p(i, j, k&
   ...
   x5b = -dp1b
   END IF
   temp43 = plim + omega*(p(i, j, 2)+two*p(i, j, 1)+p(i, j, 0)) + &
   ...
   x4b = -dp2b
   END IF
   temp22 = plim + omega*(p(i, j+2, k)+two*p(i, j+1, k)+p(i, j, k&
   ...
   x3b = -dp1b
   END IF
   temp21 = plim + omega*(p(i, 2, k)+two*p(i, 1, k)+p(i, 0, k)) + &
