   ...
   TYPE(CGNSBCDATAARRAY), DIMENSION(:), POINTER :: dirichletarrays
   TYPE(CGNSBCDATAARRAY), DIMENSION(:), POINTER :: neumannarrays
   ...
   TYPE(CGNSBCDATASETTYPE), DIMENSION(:), POINTER :: dataset
   ...
   TYPE(CGNS1TO1CONNTYPE), DIMENSION(:), POINTER :: conn1to1
   INTEGER(kind=inttype) :: nnonmatchabutting
   TYPE(CGNSNONMATCHABUTTINGCONNTYPE), DIMENSION(:), POINTER :: &
   &     connnonmatchabutting
   INTEGER(kind=inttype) :: noverset, ncellsoverset
   TYPE(CGNSOVERSETCONNTYPE), DIMENSION(:), POINTER :: connover
   INTEGER(kind=inttype) :: nholes
   TYPE(CGNSHOLESTYPE), DIMENSION(:), POINTER :: hole
   INTEGER(kind=inttype) :: nbocos
   TYPE(CGNSBOCOTYPE), DIMENSION(:), POINTER :: bocoinfo
