...
SUBROUTINE TIMESTEP_BLOCK_D(onlyradii)
  ...
  ELSE
     ...
     !          **************************************************************
     !
     !print *,'rrad_start',radId(2,3:5,4),radjd(2,3:5,4)
     SELECT CASE  (precond) 
     CASE (noprecond) 
        radid = 0.0
        radjd = 0.0
        ...
        DO k=1,ke
           DO j=1,je
              DO i=1,ie
                 ...
                 qsd = sx*uxd + sy*uyd + sz*uzd
                 qs = ux*sx + uy*sy + uz*sz - sface
!!$                 if (i==2 .and. j==5 .and. k ==4 )then
!!$                    print *,'us',ux,sx,uy,sy,uz,sz, sFace
!!$                    print *,'qs',qs
!!$                    print *,'qsd',qsd
!!$                 end if
                 IF (qs .GE. 0.) THEN
...
!!$                    end if
                 ...
                 END IF
                 result1 = SQRT(arg1)
                 radkd(i, j, k) = half*(abs3d+result1d)
                 radk(i, j, k) = half*(abs3+result1)
!!$                 if (i==2 .and. j==5 .and. k ==4 )then
!!$                    print *,'radk1',radkd(i, j, k),abs3d,result1d
!!$                 end if
           ...
           END DO
        END DO
!        print *,'rrad_basic',radId(2,3:5,4),radjd(2,3:5,4),radkd(2,3:5,4)
     CASE (turkel) 
...
!!$                 end if
                 ...
                 ELSE
                    ...
                    rk = radk(i, j, k)
                 END IF
!!$                 if (abs((rid+rjd+rkd)) >1e-15)then
!!$                    if (i==2 .and. j==5 .and. k ==4 )then
!!$                       print *,'rs',rid,rjd,rkd,i,j,k
!!$                    endif
!!$                 end if
                 ...
                 !print *,'radj',radJd(i,j,k),rjkd,rijd
        ...
        END DO
     END IF
     !print *,'rrad_scaling',radId(2,3:5,4),radjd(2,3:5,4)
