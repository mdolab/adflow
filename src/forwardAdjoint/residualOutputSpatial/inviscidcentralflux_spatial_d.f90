   ...
   !   with respect to varying inputs: *p *w *vol
   !
   !      ******************************************************************
   !      *                                                                *
   ...
   !      ******************************************************************
   !
   SUBROUTINE INVISCIDCENTRALFLUX_SPATIAL_D()
   USE INPUTPHYSICS
   USE CGNSGRID
   USE CONSTANTS
   USE BLOCKPOINTERS_D
   ...
   DO j=2,jl
   DO i=2,il
   rvold = wd(i, j, k, irho)*vol(i, j, k) + w(i, j, k, irho)*&
   &            vold0(i, j, k)
   ...
   END SUBROUTINE INVISCIDCENTRALFLUX_SPATIAL_D
