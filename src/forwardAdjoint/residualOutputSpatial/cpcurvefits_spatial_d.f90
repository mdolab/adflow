   ...
   TYPE CPTEMPFITTYPE_SPATIAL_D
   REAL(kind=realtype), DIMENSION(:), POINTER :: constants
   REAL(kind=realtype) :: eint0
   END TYPE CPTEMPFITTYPE_SPATIAL_D
   ...
   TYPE(CPTEMPFITTYPE_SPATIAL_D), DIMENSION(:), ALLOCATABLE :: cptempfitd
   ...
   END MODULE CPCURVEFITS_SPATIAL_D
