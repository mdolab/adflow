   ...
   !
   !  Differentiation of computegamma in forward (tangent) mode (with options debugTangent i4 dr8 r8):
   ...
   !      ******************************************************************
   !
   SUBROUTINE COMPUTEGAMMA_T(t, td, gamma, gammad, mm)
   USE CONSTANTS
   USE CPCURVEFITS
   USE INPUTPHYSICS
   IMPLICIT NONE
   ...
   CALL DEBUG_TGT_REAL8ARRAY('t', t, td, mm)
   ...
   CALL DEBUG_TGT_REAL8ARRAY('gamma', gamma, gammad, mm)
   CALL DEBUG_TGT_REAL8ARRAY('t', t, td, mm)
