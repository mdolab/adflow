   ...
   !
   !  Differentiation of setbcpointers in forward (tangent) mode (with options debugTangent i4 dr8 r8):
   ...
   !      ******************************************************************
   !
   SUBROUTINE SETBCPOINTERS_T(nn, ww1, ww1d, ww2, ww2d, pp1, pp1d, pp2, &
