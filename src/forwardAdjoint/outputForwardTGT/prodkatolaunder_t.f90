   ...
   !
   !  Differentiation of prodkatolaunder in forward (tangent) mode (with options debugTangent i4 dr8 r8):
   ...
   END IF
   END SUBROUTINE PRODKATOLAUNDER_T
