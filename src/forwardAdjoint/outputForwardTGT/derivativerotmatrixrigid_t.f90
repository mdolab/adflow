   ...
   !
   !  Differentiation of derivativerotmatrixrigid in forward (tangent) mode (with options debugTangent i4 dr8 r8):
   ...
   !      ******************************************************************
   !
   SUBROUTINE DERIVATIVEROTMATRIXRIGID_T(rotationmatrix, rotationmatrixd, &
   &  rotationpoint, t)
   USE INPUTMOTION
   USE FLOWVARREFSTATE
   USE MONITOR
   ...
   CALL DEBUG_TGT_REAL8ARRAY('rotationmatrix', rotationmatrix, &
   &                            rotationmatrixd, 3**2)
   CALL DEBUG_TGT_REAL8ARRAY('dm', dm, dmd, 3**2)
   ...
   END IF
   END SUBROUTINE DERIVATIVEROTMATRIXRIGID_T
