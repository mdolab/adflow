   ...
   !
   !  Differentiation of turbadvection in forward (tangent) mode (with options debugTangent i4 dr8 r8):
   ...
   !      ******************************************************************
   !
   SUBROUTINE TURBADVECTION_T(madv, nadv, offset, qq, qqd)
   USE BLOCKPOINTERS_D
   USE TURBMOD
   USE DIFFSIZES
   ...
   &                                      ISIZE4OFDrfw)
   CALL DEBUG_TGT_REAL8ARRAY('vol', vol, vold, &
   &                                      ISIZE1OFDrfvol*ISIZE2OFDrfvol*&
   &                                      ISIZE3OFDrfvol)
   ...
   &                                      *(kl-1)*madv**2)
   CALL DEBUG_TGT_REAL8('qs', qs, qsd)
   CALL DEBUG_TGT_REAL8('uu', uu, uud)
   CALL DEBUG_TGT_REAL8ARRAY('impl', impl, impld, madv)
   ...
   END IF
   END SUBROUTINE TURBADVECTION_T
