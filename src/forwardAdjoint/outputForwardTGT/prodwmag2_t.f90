   ...
   !
   !  Differentiation of prodwmag2 in forward (tangent) mode (with options debugTangent i4 dr8 r8):
   ...
   !  Hint: ISIZE3OFDrfvort should be the size of dimension 3 of array *vort
   !  Hint: ISIZE2OFDrfvort should be the size of dimension 2 of array *vort
   !  Hint: ISIZE1OFDrfvort should be the size of dimension 1 of array *vort
   IMPLICIT NONE
   !
   !      ******************************************************************
   !      *                                                                *
   ...
   CALL DEBUG_TGT_REAL8ARRAY('vort', vort, vortd, ISIZE1OFDrfvort&
   &                              *ISIZE2OFDrfvort*ISIZE3OFDrfvort)
   CALL DEBUG_TGT_REAL8('omegax', omegax, omegaxd)
   CALL DEBUG_TGT_REAL8('omegay', omegay, omegayd)
   CALL DEBUG_TGT_REAL8('omegaz', omegaz, omegazd)
