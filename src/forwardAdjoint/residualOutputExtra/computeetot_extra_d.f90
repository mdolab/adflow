   ...
   !      ******************************************************************
   !
   SUBROUTINE COMPUTEETOT_EXTRA_D(istart, iend, jstart, jend, kstart, kend&
   &  , correctfork)
   USE FLOWVARREFSTATE
   USE INPUTPHYSICS
   USE BLOCKPOINTERS_D
   ...
   DO j=jstart,jend
   DO i=istart,iend
   CALL COMPUTEETOTCELLCPFIT_EXTRA_D(i, j, k, scale, scaled, &
   &                                      correctfork)
   END DO
   END DO
   END DO
   END SELECT
   END SUBROUTINE COMPUTEETOT_EXTRA_D
