   ...
   !   variations   of useful results: rotationpoint rotationmatrix
   !   with respect to varying inputs: timeref rotpoint
   !
   !      ******************************************************************
   !      *                                                                *
   ...
   !      ******************************************************************
   !
   SUBROUTINE DERIVATIVEROTMATRIXRIGID_EXTRA_D(rotationmatrix, &
   &  rotationmatrixd, rotationpoint, rotationpointd, t)
   USE FLOWVARREFSTATE
   USE MONITOR
   USE INPUTMOTION
   IMPLICIT NONE
   ...
   dphixd = DERIVATIVERIGIDROTANGLE_EXTRA_D(degreepolxrot, coefpolxrot, &
   &    degreefourxrot, omegafourxrot, coscoeffourxrot, sincoeffourxrot, t, &
   &    dphix)
   !print *,'dphix',dphix
   dphiyd = DERIVATIVERIGIDROTANGLE_EXTRA_D(degreepolyrot, coefpolyrot, &
   &    degreefouryrot, omegafouryrot, coscoeffouryrot, sincoeffouryrot, t, &
   &    dphiy)
   !print *,'dphiy',dphiy
   dphizd = DERIVATIVERIGIDROTANGLE_EXTRA_D(degreepolzrot, coefpolzrot, &
   ...
   rotationpoint(3) = lref*rotpoint(3)
   END SUBROUTINE DERIVATIVEROTMATRIXRIGID_EXTRA_D
