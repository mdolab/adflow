   ...
   !   with respect to varying inputs: gammaconstant rgas *p *gamma
   !                *w
   !
   !      ******************************************************************
   !      *                                                                *
   ...
   !      ******************************************************************
   !
   SUBROUTINE EXTRAPOLATE2NDHALO_EXTRA_D(nn, correctfork)
   USE FLOWVARREFSTATE
   USE BCTYPES
   USE INPUTPHYSICS
   USE BLOCKPOINTERS_D
   ...
   CALL SETBCPOINTERS_EXTRA_D(nn, ww1, ww1d, ww2, ww2d, pp1, pp1d, pp2, &
   &                       pp2d, rlv1, rlv0, rev1, rev0, 0_intType)
   ...
   !gammaconstantd0 = 0.0
   CALL COMPUTEETOT_EXTRA_D(crange(1, 1), crange(1, 2), crange(2, 1), &
   &                     crange(2, 2), crange(3, 1), crange(3, 2), &
   &                     correctfork)
   END SUBROUTINE EXTRAPOLATE2NDHALO_EXTRA_D
