   ...
   !      ******************************************************************
   !
   SUBROUTINE INVISCIDUPWINDFLUX_EXTRA_D(finegrid)
   USE FLOWVARREFSTATE
   USE CGNSGRID
   USE INPUTPHYSICS
   USE BLOCKPOINTERS_D
   ...
   CALL RIEMANNFLUX_EXTRA_D(left, leftd, right, rightd, flux, &
   &                               fluxd)
   ...
   CALL LEFTRIGHTSTATE_EXTRA_D(du1, du1d, du2, du2d, du3, du3d&
   &                                  , rotmatrixi, rotmatrixid, left, leftd&
   &                                  , right, rightd)
   ...
   ! Compute the differences from the first order scheme.
   CALL LEFTRIGHTSTATE_EXTRA_D(du1, du1d, du2, du2d, du3, du3d&
   &                                  , rotmatrixj, rotmatrixjd, left, leftd&
   &                                  , right, rightd)
   ! Add the first order part to the currently stored
   ! differences, such that the correct state vector
   ! is stored.
   ...
   ! Compute the differences from the first order scheme.
   CALL LEFTRIGHTSTATE_EXTRA_D(du1, du1d, du2, du2d, du3, du3d&
   &                                  , rotmatrixk, rotmatrixkd, left, leftd&
   &                                  , right, rightd)
   ! Add the first order part to the currently stored
   ! differences, such that the correct state vector
   ! is stored.
   ...
   !      ==================================================================
   SUBROUTINE LEFTRIGHTSTATE_EXTRA_D(du1, du1d, du2, du2d, du3, du3d, &
   ...
   END IF
   END SUBROUTINE LEFTRIGHTSTATE_EXTRA_D
   !      ==================================================================
   ...
   !   with respect to varying inputs: rgas flux left right
   !        ================================================================
   SUBROUTINE RIEMANNFLUX_EXTRA_D(left, leftd, right, rightd, flux, fluxd&
   &  )
   IMPLICIT NONE
   !
   !        Subroutine arguments.
   ...
   END SELECT
   END SUBROUTINE RIEMANNFLUX_EXTRA_D
   !        ================================================================
   ...
   END SUBROUTINE INVISCIDUPWINDFLUX_EXTRA_D
