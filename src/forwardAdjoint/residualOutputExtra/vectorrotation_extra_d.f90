   ...
   !
   !  Differentiation of vectorrotation in forward (tangent) mode:
   ...
   !     ******************************************************************
   !
   SUBROUTINE VECTORROTATION_EXTRA_D(xp, xpd, yp, ypd, zp, zpd, iaxis, &
   &  angle, angled, x, xd, y, yd, z, zd)
   USE PRECISION
   IMPLICIT NONE
   !
   !     ****************************************************************
   ...
   STOP
   END SELECT
   END SUBROUTINE VECTORROTATION_EXTRA_D
