...
DIR_ORI = os.getcwd()
DIR_MOD = DIR_ORI + '/../residualOutputSpatial'
...
STR_OLD = ['BLOCKPOINTERS_SPATIAL_D','_SPATIAL_D','SETPOINTERSOFFTSINSTANCE_CD','SETPOINTERSOFFTSINSTANCE_SPATIAL_D' ]
STR_NEW = ['BLOCKPOINTERS_D','','SETPOINTERSOFFTSINSTANCE_D','SETPOINTERSOFFTSINSTANCE_D']
