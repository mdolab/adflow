...
&  nsequations=2_intType, ransequations=3_intType
  INTEGER(kind=inttype), PARAMETER :: steady=1_intType, unsteady=&
&  2_intType, timespectral=3_intType
...
&  cptempcurvefits=2_intType
  INTEGER(kind=inttype), PARAMETER :: baldwinlomax=1_intType, &
&  spalartallmaras=2_intType, spalartallmarasedwards=3_intType, &
&  komegawilcox=4_intType, komegamodified=5_intType, ktau=6_intType, &
&  mentersst=7_intType, v2f=10_intType
  INTEGER(kind=inttype), PARAMETER :: strain=1_intType, vorticity=&
&  2_intType, katolaunder=3_intType
!
!      ******************************************************************
!      *                                                                *
