...
!      ******************************************************************
!
SUBROUTINE BCEULERWALL_CD(secondhalo, correctfork)
...
!nullify(ww1, ww2, pp1, pp2, rlv1, rlv2, rev1, rev2)
      CALL SETBCPOINTERS_CD0(nn, ww1, ww2, pp1, pp2, rlv1, rlv2, rev1, &
&                       rev2, 0_intType)
!
!          **************************************************************
!          *                                                            *
...
! pointing.
          pp1(j, k) = DIM_CD(pp2(j, k), pp1(j, k))
