...
!
  ...
  END TYPE BCDATATYPE
  TYPE BCDATATYPE_SPATIAL_D
      REAL(kind=realtype), DIMENSION(:, :, :), POINTER :: norm
      REAL(kind=realtype), DIMENSION(:, :), POINTER :: rface
      REAL(kind=realtype), DIMENSION(:, :, :), POINTER :: uslip
  END TYPE BCDATATYPE_SPATIAL_D
!
!        ****************************************************************
!        *                                                              *
...
! nCellGlobal(nLev) - Global number of cells on every mg level.
  ...
  INTEGER(kind=inttype), DIMENSION(:), ALLOCATABLE :: ncellglobald
END MODULE BLOCK_SPATIAL_D
