...
!      ******************************************************************
!
SUBROUTINE INVISCIDDISSFLUXSCALAR_SPATIAL_D()
...
!dis2 = sigma*fis4*rrad 
          ...
          ELSE
            ...
            dis2 = fis2*rrad*min2
            dis4d = DIM_SPATIAL_D(fis4*rrad, fis4*rradd, dis2, dis2d, &
&              dis4)
          END IF
...
&          rhoid
    ...
    END DO
  END IF
END SUBROUTINE INVISCIDDISSFLUXSCALAR_SPATIAL_D
