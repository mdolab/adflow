   ...
   !
   !  Differentiation of curvetupyp in forward (tangent) mode (with options i4 dr8 r8):
   !   variations   of useful results: tup
   !   with respect to varying inputs: tup yp
   !   Plus diff mem management of: tup0:in tup1:in tup2:in tup3:in
   !                ypt:in
   !
   !      ==================================================================
   !
   SUBROUTINE CURVETUPYP_D(tup, tupd, yp, ypd, ntu1, ntu2)
   USE PARAMTURB
   USE INPUTPHYSICS
   USE CONSTANTS
   IMPLICIT NONE
