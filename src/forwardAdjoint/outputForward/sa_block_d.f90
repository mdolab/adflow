   ...
   !                *bmtj1 *bmtj2 (global)winf[1:10] (global)timeref
   ...
   !                bmtj1:in bmtj2:in viscsubface:in *viscsubface.utau:in
   !                bcdata:in *bcdata.norm:in *bcdata.rface:in coeftime:in
   !                (global)sections:in-out (global)ypt:in (global)tup3:in
   !                (global)tup2:in (global)tup1:in (global)tup0:in
   !
   !      ******************************************************************
   !      *                                                                *
   !      * File:          sa.f90                                          *
