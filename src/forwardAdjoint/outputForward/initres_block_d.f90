   ...
   !   with respect to varying inputs: *w *vol timeref deltat
   !   Plus diff mem management of: flowdoms:in dw:in w:in vol:in
   !                wn:in
   !
   !      ******************************************************************
   !      *                                                                *
   ...
   DO j=2,jl
   DO i=2,il
   dwd(i, j, k, l) = oneoverdtd*dw(i, j, k, l) + &
   &                    oneoverdt*dwd(i, j, k, l)
   ...
   DO j=2,jl
   DO i=2,il
   dwd(i, j, k, l) = (tmpd*vol(i, j, k)+tmp*vold(i, j, &
   &                      k))*(ww(i, j, k, l)*ww(i, j, k, irho)-w1(i, j, k, &
   &                      l)*w1(i, j, k, irho)) + tmp*vol(i, j, k)*(wwd(i, j&
   ...
   DO i=2,il
   dwd(i, j, k, l) = (tmpd*vol(i, j, k)+tmp*vold(i, j, &
   &                      k))*(ww(i, j, k, l)-w1(i, j, k, l)) + tmp*vol(i, j&
   &                      , k)*wwd(i, j, k, l)
