   ...
   !                x:in si:in sj:in sk:in coscoeffouryrot:in coscoeffourxrot:in
   !                coefpolzrot:in coefpolyrot:in coefpolxrot:in sincoeffourzrot:in
   !                sincoeffouryrot:in sincoeffourxrot:in coscoeffourzrot:in
   !                coeftime:in cgnsdoms:in
   !
   !      ******************************************************************
   !      *                                                                *
