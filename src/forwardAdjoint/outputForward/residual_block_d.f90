   ...
   !                (global)cptempfit:in (global)*cptempfit[_:_].constants:in
   !                (global)cpeint:in (global)cptrange:in (global)up3:in
   !                (global)up2:in (global)up1:in (global)up0:in (global)ret:in
   !
   !      ******************************************************************
   !      *                                                                *
   !      * File:          residual.f90                                    *
