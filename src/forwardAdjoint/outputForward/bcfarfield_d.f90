   ...
   !                rgas *rev *p *gamma *w *rlv *(*bcdata.norm)
   ...
   qn0d = u0d*bcdata(nn)%norm(i, j, 1) + u0*bcdatad(nn)%norm(i, j&
   &           , 1) + v0d*bcdata(nn)%norm(i, j, 2) + v0*bcdatad(nn)%norm(i&
   &           , j, 2) + w0d*bcdata(nn)%norm(i, j, 3) + w0*bcdatad(nn)%norm&
   &           (i, j, 3)
