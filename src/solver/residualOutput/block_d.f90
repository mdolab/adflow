...
!  and leave the real ones in the original block module
!  untouched. 
...
!
  ...
  TYPE VISCSUBFACETYPE_D
      REAL(kind=realtype), DIMENSION(:, :, :), POINTER :: tau, q
      REAL(kind=realtype), DIMENSION(:, :), POINTER :: utau
  END TYPE VISCSUBFACETYPE_D

  TYPE BLOCKTYPE

      TYPE(VISCSUBFACETYPE_D), DIMENSION(:), POINTER :: viscsubfaced
