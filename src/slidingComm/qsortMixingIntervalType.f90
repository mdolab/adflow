...
!
       ...
       type(mixingIntervalType), dimension(*), intent(inout) :: arr
!
!      Local variables.
!
...
!
       ...
       if(ierr /= 0)                               &
         call returnFail("qsortMixingIntervalType", &
       ...
       end subroutine qsortMixingIntervalType
