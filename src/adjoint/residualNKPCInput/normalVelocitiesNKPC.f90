...
!      ******************************************************************
!
       subroutine normalVelocitiesAllLevelsNKPC(sps,iCell, jCell, kCell,sFaceIAdj,&
...
!
             ...
             bocoLoop: do mm=1,nBocos
                ...
                call checkOverlapNKPC(mm,icell,jcell,kcell,isbeg,jsbeg,&
...
!       enddo levelLoop
         ...
         end subroutine normalVelocitiesAllLevelsNKPC
