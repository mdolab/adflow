...
subroutine etotArrayNKPC(rho, u, v, w, p, k, etot, correctForK, kk)
  !
  !      ******************************************************************
  !      *                                                                *
...
end subroutine etotArrayNKPC

!      ==================================================================

subroutine eintArrayNKPC(rho, p, k, eint, correctForK, kk)
  !
  !      ******************************************************************
  !      *                                                                *
