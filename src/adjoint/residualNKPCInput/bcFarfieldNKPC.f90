...
!      ******************************************************************
!
subroutine bcFarfieldNKPC(secondHalo,wInfAdj,pInfCorrAdj, wAdj,pAdj,      &
  ...
  bocos: do nnbcs=1,nBocos
     ...
     if (computeBC) then
        ...
        testFarfield: if(BCType(nnbcs) == FarField) then
           call extractBCStatesNKPC(nnbcs,wAdj,pAdj,wAdj0, wAdj1, wAdj2,wAdj3,&
