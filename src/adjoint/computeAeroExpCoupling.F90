...
!     ******************************************************************
!     *                                                                *
!     * File:          ComputeAeroExpCoupling.F90                      *
!     * Author:        C.A.(Sandy)Mader                                *
!     * Starting date: 08-15-2008                                      *
!     * Last modified: 08-15-2008                                      *
!     *                                                                *
!     ******************************************************************
!
      subroutine computeAeroExpCoupling(costFunction)
!
!     ******************************************************************
!     *                                                                *
!     * Compute the cost function partial sensitivity with respect to  *
!     * the grid coordinates and returns it:                           *
!     *                                                                *
!     *                                   dpartial J                   *
!     *   dJdx(3*nNodesGlobal)  = --------------------------           *
...
!     Local variables.
!
      integer(kind=intType) :: discr, nHalo,sps,level=1
...
!
      ...
      do idxmg=iLow, iHigh-1
        ...
        call VecGetValues(dJdx, 1, idxmg, &
...
!                       0, SUMB_PETSC_COMM_WORLD, PETScIerr)
       ...
       call mpi_allgatherv(functionGradLocal, nDesignLocal, sumb_real, &
                       functionGradCouplingExp(costFunction,:), nDesignGlobal,&
                       nDisplsGlobal, sumb_real, &
                        SUMB_PETSC_COMM_WORLD, PETScIerr)
   ...
   99 format(a,1x,i6)
    ...
    end subroutine computeAeroExpCoupling
