...
!      ******************************************************************
!
       subroutine setFlowInfinityStateAdj(velDirFreestreamAdj,liftDirectionAdj,&
...
!                       wInfAdj(irhoE), kPresent, 1_intType)
       call etotArrayAdj(rhoInfAdj, uInfAdj, vtmp, wtmp, pInfCorrAdj, ktmp, &
                   wInfAdj(irhoE), kPresent, 1)

     end subroutine setFlowInfinityStateAdj
