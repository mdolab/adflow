...
!      ******************************************************************
!      *                                                                *
!      * File:          derivativeRigidRotAngleAdj.f90                  *
...
!      ******************************************************************
!
       function derivativeRigidRotAngleAdj(degreePolRot,   &
                                        coefPolRot,     &
                                        degreeFourRot,  &
                                        omegaFourRot,   &
                                        cosCoefFourRot, &
...
!
       ...
       if(equationMode == steady) then
         derivativeRigidRotAngleAdj = zero
         return
       endif
       ...
       derivativeRigidRotAngleAdj = timeRef*dPhi

     end function derivativeRigidRotAngleAdj
