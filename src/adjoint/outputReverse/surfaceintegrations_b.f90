...
&       cofsumfxd(1) + blk*zco*cofsumfxd(3)
      mxd = mpd(1)
      fzd = blk*yco*cofsumfzd(2) - xc*myd + fpd(3) + yc*mxd + blk*xco*&
&       cofsumfzd(1) + blk*zco*cofsumfzd(3)
      fyd = blk*yco*cofsumfyd(2) + xc*mzd + fpd(2) - zc*mxd + blk*xco*&
&       cofsumfyd(1) + blk*zco*cofsumfyd(3)
