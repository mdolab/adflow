...
&   computespeedofsoundsquared_b, allnodalgradients, allnodalgradients_b
    use fluxes_b
    use aleutils_b, only : interplevelale_block, recoverlevelale_block
    implicit none
!
!      local variables.
!
...
&             velyrho*tempd32 + (gamma(i, j, k)-1)*b15d
            a15d = velzrho*tempd16 + velxrho*tempd46 + (temp6*(q/2)-sos&
&             **2)*b11d + velyrho*tempd31 + (gamma(i, j, k)-1)*b15d
            a14 = zero
            a13 = zero
            a12 = zero
            temp8 = w(i, j, k, irho)
            ...
            a51d = velzrho*tempd2 + velxrho*tempd3 + q*tempd4/2 + &
&             velyrho*tempd5 + (gamma(i, j, k)-1)*b55d
            a55d = velzrho*tempd6 + velxrho*tempd7 + (temp34*(q/2)-sos**&
&             2)*b51d + velyrho*tempd8 + (gamma(i, j, k)-1)*b55d
            a54 = one*w(i, j, k, irho)*velzrho
            call popreal8(b54)
            temp39 = w(i, j, k, irho)
...
&             a15*tempd16 + a11*tempd17 + a25*tempd18 + a21*tempd19 + &
&             a35*tempd20 + a31*tempd21 + a45*tempd22 + a41*tempd23 + &
&             a55*tempd6 + a51*tempd2
...
&             a15*tempd31 + a11*tempd32 + a25*tempd33 + a21*tempd34 + &
&             a35*tempd35 + a31*tempd36 + a45*tempd37 + a41*tempd38 + &
&             a55*tempd8 + a51*tempd5
...
&             a15*tempd46 + a11*tempd47 + a25*tempd48 + a21*tempd49 + &
&             a35*tempd50 + a31*tempd51 + a45*tempd52 + a41*tempd53 + &
&             a55*tempd7 + a51*tempd3
...
&             temp20*a35*b31d/2 + a31*tempd57/2 + temp34*a55*b51d/2 + &
&             a51*tempd4/2
...
&             **2 - velxrho*2*tempd45/sos - velyrho*2*tempd30/sos - &
&             velzrho*2*tempd15/sos - a15*2*sos*b11d - a35*2*sos*b31d - &
&             a55*2*sos*b51d
            call popreal8(b44)
            temp32 = w(i, j, k, irho)
...
&             temp26 - velyrho*tempd25/temp28 - velxrho*tempd40/temp29
            ...
            call popreal8(b31)
            wd(i, j, k, irho) = wd(i, j, k, irho) - velzrho*tempd11/&
&             temp19 - a33*velyrho*tempd26/temp21 - velxrho*tempd41/&
&             temp22
            call popreal8(b24)
            temp18 = w(i, j, k, irho)
            ...
            call popreal8(b21)
            wd(i, j, k, irho) = wd(i, j, k, irho) - velzrho*tempd12/&
&             temp12 - velyrho*tempd27/temp14 - a22*velxrho*tempd42/&
&             temp15
            call popreal8(b14)
            temp11 = w(i, j, k, irho)
            ...
            call popreal8(b11)
            wd(i, j, k, irho) = wd(i, j, k, irho) - velzrho*tempd13/&
&             temp5 - velyrho*tempd28/temp7 - velxrho*tempd43/temp8
