   ...
   & isize2ofdrfdrfbcdata_fp, isize3ofdrfdrfbcdata_fp
   INTEGER(kind=inttype) :: isize1ofdrfdrfbcdata_fv, &
   & isize2ofdrfdrfbcdata_fv, isize3ofdrfdrfbcdata_fv
   ...
   & isize2ofdrfdrfbcdata_oarea, isize3ofdrfdrfbcdata_oarea
   ...
   & isize2ofdrfdrfbcdata_cavitation
   ...
   & isize2ofdrfdrfbcdata_uslip, isize3ofdrfdrfbcdata_uslip
   ...
   INTEGER(kind=inttype) :: isize1ofdrfdtl, isize2ofdrfdtl, &
   & isize3ofdrfdtl
   INTEGER(kind=inttype) :: isize1ofdrfdrfviscsubface_utau, &
   & isize2ofdrfdrfviscsubface_utau
   END MODULE DIFFSIZES_B
