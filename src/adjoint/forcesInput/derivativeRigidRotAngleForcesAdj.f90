...
!      ******************************************************************
!      *                                                                *
!      * File:          derivativeRigidRotAngleForcesAdj.f90            *
...
!      ******************************************************************
!
       function derivativeRigidRotAngleForcesAdj(degreePolRot,   &
                                        coefPolRot,     &
                                        degreeFourRot,  &
                                        omegaFourRot,   &
                                        cosCoefFourRot, &
...
!
       ...
       if(equationMode == steady) then
         derivativeRigidRotAngleForcesAdj = zero
         return
       endif
       ...
       derivativeRigidRotAngleForcesAdj = timeRef*dPhi

     end function derivativeRigidRotAngleForcesAdj
