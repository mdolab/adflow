...
!
 ...
 !     if( myID==0 ) write(*,*) "Running verifydCfdx...",sps
      ...
      allocate(dCL(nDom,ie,je,ke,3), dCLfd(nDom,ie,je,ke,3))
      allocate(dCD(nDom,ie,je,ke,3), dCDfd(nDom,ie,je,ke,3))
      allocate(dCmx(nDom,ie,je,ke,3), dCmxfd(nDom,ie,je,ke,3))
       
      allocate(dCLer(nDom,ie,je,ke,3))
      allocate(dCDer(nDom,ie,je,ke,3))
      allocate(dCmxer(nDom,ie,je,ke,3))
