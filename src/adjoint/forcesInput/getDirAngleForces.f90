...
!     ******************************************************************
!
      subroutine getDirAngleForces(freeStreamAxis,liftAxis,liftIndex,alpha,beta)
!
!     ******************************************************************
!     *                                                                *
...
!
      ...
      if (flowIndex .ne. 1) then
         call terminate('getDirAngleforces', 'Dominant Flow not in +ve x direction')
      endif
      !print *,'flow Index'
      ...
      elseif (liftIndex ==3) then
         ...
         call terminate('getDirAngleforces', 'Invalid Lift Direction')
      endif

      !print *,'end get angle'
      

    end subroutine getDirAngleForces
