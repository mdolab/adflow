...
!      ******************************************************************
!
       subroutine derivativeRotMatrixRigidForcesAdj(rotationMatrixAdj, &
                                           rotationPointAdj,rotPointAdj, t)
!
!      ******************************************************************
!      *                                                                *
...
!
       ...
       real(kind=realType), dimension(3,3), intent(out) :: rotationMatrixAdj
...
!
       ...
       real(kind=realType) :: derivativeRigidRotAngleForcesAdj
!
!      ******************************************************************
!      *                                                                *
!      * Begin execution                                                *
...
!
       ...
       phi = rigidRotAngleForcesAdj(degreePolXRot,   coefPolXRot,      &
       ...
       phi = rigidRotAngleForcesAdj(degreePolYRot,   coefPolYRot,      &
       ...
       phi = rigidRotAngleForcesAdj(degreePolZRot,   coefPolZRot,      &
       ...
       dphiX = derivativeRigidRotAngleForcesAdj(degreePolXRot,   &
                                       coefPolXRot,     &
                                       degreeFourXRot,  &
                                       omegaFourXRot,   &
                                       cosCoefFourXRot, &
       ...
       dphiY = derivativeRigidRotAngleForcesAdj(degreePolYRot,   &
                                       coefPolYRot,     &
                                       degreeFourYRot,  &
                                       omegaFourYRot,   &
                                       cosCoefFourYRot, &
       ...
       dphiZ = derivativeRigidRotAngleForcesAdj(degreePolZRot,   &
                                       coefPolZRot,     &
                                       degreeFourZRot,  &
                                       omegaFourZRot,   &
                                       cosCoefFourZRot, &
       ...
       do j=1,3
         do i=1,3
           rotationMatrixAdj(i,j) = dm(i,1)*m(j,1) + dm(i,2)*m(j,2) &
                               + dm(i,3)*m(j,3)
         enddo
       enddo
    ...
    !                    + MachGrid(3)*aInf*t/timeRef
     ...
     end subroutine derivativeRotMatrixRigidForcesAdj
