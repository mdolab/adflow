   ...
   !  
   !  Differentiation of invisciddissfluxscalaradjts in reverse (adjoint) mode:
   ...
   !      ******************************************************************
   !
   SUBROUTINE INVISCIDDISSFLUXSCALARADJTS_B(wadj, wadjb, padj, padjb, dwadj&
   ...
   END IF
   END IF
   END SUBROUTINE INVISCIDDISSFLUXSCALARADJTS_B
