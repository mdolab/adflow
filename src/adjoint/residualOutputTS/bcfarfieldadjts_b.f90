   ...
   !  
   !  Differentiation of bcfarfieldadjts in reverse (adjoint) mode:
   ...
   !      ******************************************************************
   !
   SUBROUTINE BCFARFIELDADJTS_B(secondhalo, winfadj, winfadjb, pinfcorradj&
   &  , pinfcorradjb, wadj, wadjb, padj, padjb, siadj, sjadj, skadj, &
   &  normadj, normadjb, rfaceadj, icell, jcell, kcell, nn, level, sps)
   USE bctypes
   ...
   !!$                 endif
   !!$                 write(unitxAD,11)int((icbeg+icend)/2),int((jcbeg+jcend)/2), i,j,nnbcs,normAdj(nnbcs,ii,jj,1,sps), rFaceAdj(nn
   !bcs,ii,jj,sps) 
   ...
   END SUBROUTINE BCFARFIELDADJTS_B
