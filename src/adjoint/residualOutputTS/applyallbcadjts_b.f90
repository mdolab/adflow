   ...
   !  
   !  Differentiation of applyallbcadjts in reverse (adjoint) mode:
   ...
   !      ******************************************************************
   !
   SUBROUTINE APPLYALLBCADJTS_B(winfadj, winfadjb, pinfcorradj, &
   &  pinfcorradjb, wadj, wadjb, padj, padjb, sadj, sadjb, siadj, siadjb, &
   &  sjadj, sjadjb, skadj, skadjb, voladj, normadj, normadjb, rfaceadj, &
   &  rfaceadjb, icell, jcell, kcell, secondhalo, nn, level, sps)
   USE bctypes
   USE blockpointers
   USE flowvarrefstate
   ...
   !*************************
   CALL BCSYMMADJTS(wadj, padj, normadj, icell, jcell, kcell, secondhalo&
   &             , nn, level, sps)
   ...
   CALL PUSHINTEGER4(0)
   END SELECT
   CALL BCEULERWALLADJTS_B(secondhalo, wadj, wadjb, padj, padjb, sadj, &
   &                    sadjb, siadj, siadjb, sjadj, sjadjb, skadj, skadjb&
   &                    , normadj, normadjb, rfaceadj, rfaceadjb, icell, &
   ...
   CALL BCFARFIELDADJTS_B(secondhalo, winfadj, winfadjb, pinfcorradj&
   &                       , pinfcorradjb, wadj, wadjb, padj, padjb, siadj&
   &                       , sjadj, skadj, normadj, normadjb, rfaceadj, &
   ...
   CALL POPREAL8ARRAY(wadj, 5**3*nw*ntimeintervalsspectral)
   CALL POPBOOLEAN(secondhalo)
   CALL BCSYMMADJTS_B(wadj, wadjb, padj, padjb, normadj, normadjb, icell&
   &               , jcell, kcell, secondhalo, nn, level, sps)
   END SUBROUTINE APPLYALLBCADJTS_B
