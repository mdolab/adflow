   ...
   !  
   !  Differentiation of getdirvectorts in reverse (adjoint) mode:
   ...
   !     ******************************************************************
   !
   SUBROUTINE GETDIRVECTORTS_B(refdirection, alpha, alphab, beta, betab, &
   ...
   arg1 = -alpha
   CALL VECTORROTATIONTS(x1, y1, z1, 3, arg1, xbn, ybn, zbn)
   CALL PUSHREAL8(arg1)
   ...
   IF (branch .LT. 1) THEN
   arg1b = 0.0
   CALL VECTORROTATIONTS_B(xw, xwb, yw, ywb, zw, zwb, 2, arg1, arg1b&
   &                        , x1, x1b, y1, y1b, z1, z1b)
   CALL POPREAL8(arg1)
   betab = betab - arg1b
   arg1b = 0.0
   CALL VECTORROTATIONTS_B(x1, x1b, y1, y1b, z1, z1b, 3, arg1, arg1b&
   &                        , xbn, xbnb, ybn, ybnb, zbn, zbnb)
   alphab = alphab - arg1b
   END IF
   ELSE
   CALL VECTORROTATIONTS_B(xw, xwb, yw, ywb, zw, zwb, 3, beta, betab, &
   &                      x1, x1b, y1, y1b, z1, z1b)
   CALL VECTORROTATIONTS_B(x1, x1b, y1, y1b, z1, z1b, 2, alpha, alphab&
   &                      , xbn, xbnb, ybn, ybnb, zbn, zbnb)
   END IF
   END SUBROUTINE GETDIRVECTORTS_B
