   ...
   !  
   !  Differentiation of replacebcstatesadjts in reverse (adjoint) mode:
   ...
   !      ******************************************************************
   !
   SUBROUTINE REPLACEBCSTATESADJTS_B(nn, wadj0, wadj0b, wadj1, wadj1b, &
   &  wadj2, wadj3, padj0, padj0b, padj1, padj1b, padj2, padj3, rlvadj1, &
   &  rlvadj2, revadj1, revadj2, icell, jcell, kcell, wadj, wadjb, padj, &
   &  padjb, rlvadj, revadj, secondhalo, nnn, level, sps)
   USE bctypes
   ...
   !===========================================================
   IF (secondhalo) THEN
   padj1b(-2:2, -2:2) = padj1b(-2:2, -2:2) + padjb(1, -2:2, -2:2, sps&
   &        )
   padjb(1, -2:2, -2:2, sps) = 0.0
   padj0b(-2:2, -2:2) = padj0b(-2:2, -2:2) + padjb(2, -2:2, -2:2, sps&
   &        )
   padjb(2, -2:2, -2:2, sps) = 0.0
   wadj1b(-2:2, -2:2, 1:nw) = wadj1b(-2:2, -2:2, 1:nw) + wadjb(1, -2:&
   &        2, -2:2, 1:nw, sps)
   ...
   wadjb(2, -2:2, -2:2, 1:nw, sps) = 0.0
   ELSE
   padj1b(-2:2, -2:2) = padj1b(-2:2, -2:2) + padjb(2, -2:2, -2:2, sps&
   &        )
   padjb(2, -2:2, -2:2, sps) = 0.0
   wadj1b(-2:2, -2:2, 1:nw) = wadj1b(-2:2, -2:2, 1:nw) + wadjb(2, -2:&
   &        2, -2:2, 1:nw, sps)
   ...
   &        sps)
   padjb(-2:2, -1, -2:2, sps) = 0.0
   padj0b(-2:2, -2:2) = padj0b(-2:2, -2:2) + padjb(-2:2, -2, -2:2, &
   &        sps)
   padjb(-2:2, -2, -2:2, sps) = 0.0
   wadj1b(-2:2, -2:2, 1:nw) = wadj1b(-2:2, -2:2, 1:nw) + wadjb(-2:2, &
   &        -1, -2:2, 1:nw, sps)
   wadjb(-2:2, -1, -2:2, 1:nw, sps) = 0.0
   wadj0b(-2:2, -2:2, 1:nw) = wadj0b(-2:2, -2:2, 1:nw) + wadjb(-2:2, &
   &        -2, -2:2, 1:nw, sps)
   wadjb(-2:2, -2, -2:2, 1:nw, sps) = 0.0
   ELSE
   ...
   !===========================================================
   IF (secondhalo) THEN
   padj1b(-2:2, -2:2) = padj1b(-2:2, -2:2) + padjb(-2:2, 1, -2:2, sps&
   &        )
   padjb(-2:2, 1, -2:2, sps) = 0.0
   padj0b(-2:2, -2:2) = padj0b(-2:2, -2:2) + padjb(-2:2, 2, -2:2, sps&
   &        )
   ...
   &        sps)
   padjb(-2:2, -2:2, -1, sps) = 0.0
   padj0b(-2:2, -2:2) = padj0b(-2:2, -2:2) + padjb(-2:2, -2:2, -2, &
   &        sps)
   padjb(-2:2, -2:2, -2, sps) = 0.0
   wadj1b(-2:2, -2:2, 1:nw) = wadj1b(-2:2, -2:2, 1:nw) + wadjb(-2:2, &
   &        -2:2, -1, 1:nw, sps)
   wadjb(-2:2, -2:2, -1, 1:nw, sps) = 0.0
   wadj0b(-2:2, -2:2, 1:nw) = wadj0b(-2:2, -2:2, 1:nw) + wadjb(-2:2, &
   &        -2:2, -2, 1:nw, sps)
   wadjb(-2:2, -2:2, -2, 1:nw, sps) = 0.0
   ELSE
   ...
   !===========================================================
   IF (secondhalo) THEN
   padj1b(-2:2, -2:2) = padj1b(-2:2, -2:2) + padjb(-2:2, -2:2, 1, sps&
   &        )
   padjb(-2:2, -2:2, 1, sps) = 0.0
   padj0b(-2:2, -2:2) = padj0b(-2:2, -2:2) + padjb(-2:2, -2:2, 2, sps&
   &        )
   ...
   END IF
   END SELECT
   END SUBROUTINE REPLACEBCSTATESADJTS_B
