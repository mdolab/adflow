   ...
   !  
   !  Differentiation of checkinputparamadjts in reverse (adjoint) mode:
   ...
   !      ******************************************************************
   !
   SUBROUTINE CHECKINPUTPARAMADJTS_B(veldirfreestreamadj, &
   ...
   END IF
   END SUBROUTINE CHECKINPUTPARAMADJTS_B
