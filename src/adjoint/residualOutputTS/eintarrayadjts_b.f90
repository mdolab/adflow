   ...
   !  
   !  Differentiation of eintarrayadjts in reverse (adjoint) mode:
   !   gradient, with respect to input variables: p eint gammaconstant
   !   of linear combination of output variables: p eint
   !      ==================================================================
   SUBROUTINE EINTARRAYADJTS_B(rho, p, pb, k, eint, eintb, correctfork, kk)
   USE constants
   USE cpcurvefits
   USE flowvarrefstate
   USE inputphysics
   ...
   END SELECT
   !gammaconstantb0 = 0.0
   END SUBROUTINE EINTARRAYADJTS_B
