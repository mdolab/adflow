   ...
   !      ******************************************************************
   !
   SUBROUTINE RESIDUALADJTS_B(wadj, wadjb, padj, padjb, siadj, siadjb, &
   &  sjadj, sjadjb, skadj, skadjb, voladj, voladjb, normadj, sfaceiadj, &
   ...
   CALL INVISCIDCENTRALFLUXADJTS(wadj, padj, dwadj, siadj, sjadj, skadj, &
   ...
   CALL INVISCIDDISSFLUXSCALARADJTS(wadj, padj, dwadj, radiadj, &
   &                                 radjadj, radkadj, icell, jcell, kcell&
   &                                 , nn, level, sps)
   !!$!               do i = 1,nw
   !!$!                  !if (abs(dwAdj(i)-dwAdj2(i))>0.0) then
   ...
   CALL INVISCIDDISSFLUXSCALARADJTS_B(wadj, wadjb, padj, padjb, dwadj&
   ...
   radiadjb(-1:1, -1:1, -1:1, 1:ntimeintervalsspectral) = 0.0
   END IF
   CALL INVISCIDCENTRALFLUXADJTS_B(wadj, wadjb, padj, padjb, dwadj, &
   &                            dwadjb, siadj, siadjb, sjadj, sjadjb, skadj&
   &                            , skadjb, voladj, voladjb, sfaceiadj, &
   &                            sfaceiadjb, sfacejadj, sfacejadjb, &
   &                            sfacekadj, sfacekadjb, rotrateadj, &
   &                            rotrateadjb, icell, jcell, kcell, nn, level&
   &                            , sps)
   CALL POPINTEGER4(branch)
   CALL POPINTEGER4(branch)
   CALL POPINTEGER4(branch)
...
!!$   vis2b0 = 0.0
!!$   sigmab = 0.0
   END SUBROUTINE RESIDUALADJTS_B
