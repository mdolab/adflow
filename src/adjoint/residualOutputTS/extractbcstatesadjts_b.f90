   ...
   !  
   !  Differentiation of extractbcstatesadjts in reverse (adjoint) mode:
   ...
   !      ******************************************************************
   !
   SUBROUTINE EXTRACTBCSTATESADJTS_B(nn, wadj, wadjb, padj, padjb, wadj0, &
   ...
   END IF
   IF (secondhalo) THEN
   padjb(1, -2:2, -2:2, sps) = padjb(1, -2:2, -2:2, sps) + padj3b(-2:&
   &        2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(0, -2:2, -2:2, sps) = padjb(0, -2:2, -2:2, sps) + padj2b(-2:&
   &        2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(-1, -2:2, -2:2, sps) = padjb(-1, -2:2, -2:2, sps) + padj1b(-&
   &        2:2, -2:2)
   padj1b(-2:2, -2:2) = 0.0
   padjb(-2, -2:2, -2:2, sps) = padjb(-2, -2:2, -2:2, sps) + padj0b(-&
   &        2:2, -2:2)
   padj0b(-2:2, -2:2) = 0.0
   wadjb(1, -2:2, -2:2, 1:nw, sps) = wadjb(1, -2:2, -2:2, 1:nw, sps) &
   &        + wadj3b(-2:2, -2:2, 1:nw)
   wadj3b(-2:2, -2:2, 1:nw) = 0.0
   wadjb(0, -2:2, -2:2, 1:nw, sps) = wadjb(0, -2:2, -2:2, 1:nw, sps) &
   &        + wadj2b(-2:2, -2:2, 1:nw)
   wadj2b(-2:2, -2:2, 1:nw) = 0.0
   wadjb(-1, -2:2, -2:2, 1:nw, sps) = wadjb(-1, -2:2, -2:2, 1:nw, sps&
   &        ) + wadj1b(-2:2, -2:2, 1:nw)
   wadj1b(-2:2, -2:2, 1:nw) = 0.0
   wadjb(-2, -2:2, -2:2, 1:nw, sps) = wadjb(-2, -2:2, -2:2, 1:nw, sps&
   &        ) + wadj0b(-2:2, -2:2, 1:nw)
   wadj0b(-2:2, -2:2, 1:nw) = 0.0
   ELSE
   padjb(0, -2:2, -2:2, sps) = padjb(0, -2:2, -2:2, sps) + padj3b(-2:&
   &        2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(-1, -2:2, -2:2, sps) = padjb(-1, -2:2, -2:2, sps) + padj2b(-&
   &        2:2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(-2, -2:2, -2:2, sps) = padjb(-2, -2:2, -2:2, sps) + padj1b(-&
   &        2:2, -2:2)
   padj1b(-2:2, -2:2) = 0.0
   wadjb(0, -2:2, -2:2, 1:nw, sps) = wadjb(0, -2:2, -2:2, 1:nw, sps) &
   &        + wadj3b(-2:2, -2:2, 1:nw)
   ...
   END IF
   IF (secondhalo) THEN
   padjb(-1, -2:2, -2:2, sps) = padjb(-1, -2:2, -2:2, sps) + padj3b(-&
   &        2:2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(0, -2:2, -2:2, sps) = padjb(0, -2:2, -2:2, sps) + padj2b(-2:&
   &        2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(1, -2:2, -2:2, sps) = padjb(1, -2:2, -2:2, sps) + padj1b(-2:&
   &        2, -2:2)
   padj1b(-2:2, -2:2) = 0.0
   padjb(2, -2:2, -2:2, sps) = padjb(2, -2:2, -2:2, sps) + padj0b(-2:&
   &        2, -2:2)
   padj0b(-2:2, -2:2) = 0.0
   wadjb(-1, -2:2, -2:2, 1:nw, sps) = wadjb(-1, -2:2, -2:2, 1:nw, sps&
   &        ) + wadj3b(-2:2, -2:2, 1:nw)
   ...
   &        2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(1, -2:2, -2:2, sps) = padjb(1, -2:2, -2:2, sps) + padj2b(-2:&
   &        2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(2, -2:2, -2:2, sps) = padjb(2, -2:2, -2:2, sps) + padj1b(-2:&
   &        2, -2:2)
   padj1b(-2:2, -2:2) = 0.0
   wadjb(0, -2:2, -2:2, 1:nw, sps) = wadjb(0, -2:2, -2:2, 1:nw, sps) &
   &        + wadj3b(-2:2, -2:2, 1:nw)
   ...
   END IF
   IF (secondhalo) THEN
   padjb(-2:2, 1, -2:2, sps) = padjb(-2:2, 1, -2:2, sps) + padj3b(-2:&
   &        2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(-2:2, 0, -2:2, sps) = padjb(-2:2, 0, -2:2, sps) + padj2b(-2:&
   &        2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(-2:2, -1, -2:2, sps) = padjb(-2:2, -1, -2:2, sps) + padj1b(-&
   &        2:2, -2:2)
   padj1b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2, -2:2, sps) = padjb(-2:2, -2, -2:2, sps) + padj0b(-&
   &        2:2, -2:2)
   padj0b(-2:2, -2:2) = 0.0
   wadjb(-2:2, 1, -2:2, 1:nw, sps) = wadjb(-2:2, 1, -2:2, 1:nw, sps) &
   &        + wadj3b(-2:2, -2:2, 1:nw)
   wadj3b(-2:2, -2:2, 1:nw) = 0.0
   wadjb(-2:2, 0, -2:2, 1:nw, sps) = wadjb(-2:2, 0, -2:2, 1:nw, sps) &
   &        + wadj2b(-2:2, -2:2, 1:nw)
   wadj2b(-2:2, -2:2, 1:nw) = 0.0
   wadjb(-2:2, -1, -2:2, 1:nw, sps) = wadjb(-2:2, -1, -2:2, 1:nw, sps&
   &        ) + wadj1b(-2:2, -2:2, 1:nw)
   ...
   wadj0b(-2:2, -2:2, 1:nw) = 0.0
   ELSE
   padjb(-2:2, 0, -2:2, sps) = padjb(-2:2, 0, -2:2, sps) + padj3b(-2:&
   &        2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(-2:2, -1, -2:2, sps) = padjb(-2:2, -1, -2:2, sps) + padj2b(-&
   &        2:2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2, -2:2, sps) = padjb(-2:2, -2, -2:2, sps) + padj1b(-&
   &        2:2, -2:2)
   ...
   END IF
   IF (secondhalo) THEN
   padjb(-2:2, -1, -2:2, sps) = padjb(-2:2, -1, -2:2, sps) + padj3b(-&
   &        2:2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(-2:2, 0, -2:2, sps) = padjb(-2:2, 0, -2:2, sps) + padj2b(-2:&
   &        2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(-2:2, 1, -2:2, sps) = padjb(-2:2, 1, -2:2, sps) + padj1b(-2:&
   &        2, -2:2)
   padj1b(-2:2, -2:2) = 0.0
   padjb(-2:2, 2, -2:2, sps) = padjb(-2:2, 2, -2:2, sps) + padj0b(-2:&
   &        2, -2:2)
   ...
   &        2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(-2:2, 1, -2:2, sps) = padjb(-2:2, 1, -2:2, sps) + padj2b(-2:&
   &        2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(-2:2, 2, -2:2, sps) = padjb(-2:2, 2, -2:2, sps) + padj1b(-2:&
   &        2, -2:2)
   ...
   END IF
   IF (secondhalo) THEN
   padjb(-2:2, -2:2, 1, sps) = padjb(-2:2, -2:2, 1, sps) + padj3b(-2:&
   &        2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2:2, 0, sps) = padjb(-2:2, -2:2, 0, sps) + padj2b(-2:&
   &        2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2:2, -1, sps) = padjb(-2:2, -2:2, -1, sps) + padj1b(-&
   &        2:2, -2:2)
   padj1b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2:2, -2, sps) = padjb(-2:2, -2:2, -2, sps) + padj0b(-&
   &        2:2, -2:2)
   padj0b(-2:2, -2:2) = 0.0
   wadjb(-2:2, -2:2, 1, 1:nw, sps) = wadjb(-2:2, -2:2, 1, 1:nw, sps) &
   &        + wadj3b(-2:2, -2:2, 1:nw)
   wadj3b(-2:2, -2:2, 1:nw) = 0.0
   wadjb(-2:2, -2:2, 0, 1:nw, sps) = wadjb(-2:2, -2:2, 0, 1:nw, sps) &
   &        + wadj2b(-2:2, -2:2, 1:nw)
   wadj2b(-2:2, -2:2, 1:nw) = 0.0
   wadjb(-2:2, -2:2, -1, 1:nw, sps) = wadjb(-2:2, -2:2, -1, 1:nw, sps&
   &        ) + wadj1b(-2:2, -2:2, 1:nw)
   ...
   wadj0b(-2:2, -2:2, 1:nw) = 0.0
   ELSE
   padjb(-2:2, -2:2, 0, sps) = padjb(-2:2, -2:2, 0, sps) + padj3b(-2:&
   &        2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2:2, -1, sps) = padjb(-2:2, -2:2, -1, sps) + padj2b(-&
   &        2:2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2:2, -2, sps) = padjb(-2:2, -2:2, -2, sps) + padj1b(-&
   &        2:2, -2:2)
   ...
   END IF
   IF (secondhalo) THEN
   padjb(-2:2, -2:2, -1, sps) = padjb(-2:2, -2:2, -1, sps) + padj3b(-&
   &        2:2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2:2, 0, sps) = padjb(-2:2, -2:2, 0, sps) + padj2b(-2:&
   &        2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2:2, 1, sps) = padjb(-2:2, -2:2, 1, sps) + padj1b(-2:&
   &        2, -2:2)
   padj1b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2:2, 2, sps) = padjb(-2:2, -2:2, 2, sps) + padj0b(-2:&
   &        2, -2:2)
   ...
   &        2, -2:2)
   padj3b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2:2, 1, sps) = padjb(-2:2, -2:2, 1, sps) + padj2b(-2:&
   &        2, -2:2)
   padj2b(-2:2, -2:2) = 0.0
   padjb(-2:2, -2:2, 2, sps) = padjb(-2:2, -2:2, 2, sps) + padj1b(-2:&
   &        2, -2:2)
   ...
   CALL POPINTEGER4(branch)
   CALL POPINTEGER4(branch)
   END SUBROUTINE EXTRACTBCSTATESADJTS_B
