   ...
   !  
   !  Differentiation of vectorrotationts in reverse (adjoint) mode:
   ...
   !     ******************************************************************
   !
   SUBROUTINE VECTORROTATIONTS_B(xp, xpb, yp, ypb, zp, zpb, iaxis, angle, &
   ...
   &      -y*SIN(angle))*ypb
   END SELECT
   END SUBROUTINE VECTORROTATIONTS_B
