   ...
   !  
   !  Differentiation of xhaloadjts in reverse (adjoint) mode:
   ...
   !      ******************************************************************
   !
   SUBROUTINE XHALOADJTS_B(xadj, xadjb, xblockcorneradj, xblockcorneradjb, &
   ...
   xadj(iminoffset, j, k, 1, sps) = two*xadj(iminoffset+1, &
   &                  j, k, 1, sps) - xadj(iminoffset+2, j, k, 1, sps)
   xadj(iminoffset, j, k, 2, sps) = two*xadj(iminoffset+1, &
   &                  j, k, 2, sps) - xadj(iminoffset+2, j, k, 2, sps)
   xadj(iminoffset, j, k, 3, sps) = two*xadj(iminoffset+1, &
   &                  j, k, 3, sps) - xadj(iminoffset+2, j, k, 3, sps)
   CALL PUSHINTEGER4(3)
   ELSE
   CALL PUSHINTEGER4(2)
   END IF
   ...
   IF (kkk .GE. 1 .AND. jjj .GE. 1) THEN
   IF (kkk .LE. kl .AND. jjj .LE. jl) THEN
   xadj(imaxoffset, j, k, 1, sps) = two*xadj(imaxoffset-1, &
   &                  j, k, 1, sps) - xadj(imaxoffset-2, j, k, 1, sps)
   xadj(imaxoffset, j, k, 2, sps) = two*xadj(imaxoffset-1, &
   &                  j, k, 2, sps) - xadj(imaxoffset-2, j, k, 2, sps)
   xadj(imaxoffset, j, k, 3, sps) = two*xadj(imaxoffset-1, &
   &                  j, k, 3, sps) - xadj(imaxoffset-2, j, k, 3, sps)
   CALL PUSHINTEGER4(3)
   ELSE
   CALL PUSHINTEGER4(2)
   END IF
   ...
   xadj(i, jminoffset, k, 1, sps) = two*xadj(i, jminoffset+&
   &                  1, k, 1, sps) - xadj(i, jminoffset+2, k, 1, sps)
   xadj(i, jminoffset, k, 2, sps) = two*xadj(i, jminoffset+&
   &                  1, k, 2, sps) - xadj(i, jminoffset+2, k, 2, sps)
   xadj(i, jminoffset, k, 3, sps) = two*xadj(i, jminoffset+&
   &                  1, k, 3, sps) - xadj(i, jminoffset+2, k, 3, sps)
   CALL PUSHINTEGER4(3)
   ELSE
   CALL PUSHINTEGER4(2)
   END IF
   ...
   IF (kkk .GE. 1 .AND. iii .GE. 0) THEN
   IF (kkk .LE. kl .AND. iii .LE. ie) THEN
   xadj(i, jmaxoffset, k, 1, sps) = two*xadj(i, jmaxoffset-&
   &                  1, k, 1, sps) - xadj(i, jmaxoffset-2, k, 1, sps)
   xadj(i, jmaxoffset, k, 2, sps) = two*xadj(i, jmaxoffset-&
   &                  1, k, 2, sps) - xadj(i, jmaxoffset-2, k, 2, sps)
   xadj(i, jmaxoffset, k, 3, sps) = two*xadj(i, jmaxoffset-&
   &                  1, k, 3, sps) - xadj(i, jmaxoffset-2, k, 3, sps)
   CALL PUSHINTEGER4(3)
   ELSE
   CALL PUSHINTEGER4(2)
   END IF
   ...
   xadj(i, j, kminoffset, 1, sps) = two*xadj(i, j, &
   &                  kminoffset+1, 1, sps) - xadj(i, j, kminoffset+2, 1, &
   &                  sps)
   xadj(i, j, kminoffset, 2, sps) = two*xadj(i, j, &
   &                  kminoffset+1, 2, sps) - xadj(i, j, kminoffset+2, 2, &
   &                  sps)
   xadj(i, j, kminoffset, 3, sps) = two*xadj(i, j, &
   &                  kminoffset+1, 3, sps) - xadj(i, j, kminoffset+2, 3, &
   &                  sps)
   CALL PUSHINTEGER4(3)
   ELSE
   CALL PUSHINTEGER4(2)
   ...
   IF (jjj .GE. 0 .AND. iii .GE. 0) THEN
   IF (jjj .LE. je .AND. iii .LE. ie) THEN
   xadj(i, j, kmaxoffset, 1, sps) = two*xadj(i, j, &
   &                  kmaxoffset-1, 1, sps) - xadj(i, j, kmaxoffset-2, 1, &
   &                  sps)
   xadj(i, j, kmaxoffset, 2, sps) = two*xadj(i, j, &
   &                  kmaxoffset-1, 2, sps) - xadj(i, j, kmaxoffset-2, 2, &
   &                  sps)
   xadj(i, j, kmaxoffset, 3, sps) = two*xadj(i, j, &
   &                  kmaxoffset-1, 3, sps) - xadj(i, j, kmaxoffset-2, 3, &
   &                  sps)
   CALL PUSHINTEGER4(3)
   ELSE
   CALL PUSHINTEGER4(2)
   ...
   GOTO 190
   ELSE
   xadjb(0, -3:2, -3:2, 1:3, sps) = xadjb(0, -3:2, -3:2, 1:3, &
   &              sps) + x2b(-3:2, -3:2, 1:3)
   x2b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-1, -3:2, -3:2, 1:3, sps) = xadjb(-1, -3:2, -3:2, 1:3&
   &              , sps) + x1b(-3:2, -3:2, 1:3)
   x1b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-2, -3:2, -3:2, 1:3, sps) = xadjb(-2, -3:2, -3:2, 1:3&
   &              , sps) + x0b(-3:2, -3:2, 1:3)
   x0b(-3:2, -3:2, 1:3) = 0.0
   END IF
   ...
   &            sps) + x1b(-3:2, -3:2, 1:3)
   x1b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-3, -3:2, -3:2, 1:3, sps) = xadjb(-3, -3:2, -3:2, 1:3, &
   &            sps) + x0b(-3:2, -3:2, 1:3)
   x0b(-3:2, -3:2, 1:3) = 0.0
   ELSE
   xadjb(-1, -3:2, -3:2, 1:3, sps) = xadjb(-1, -3:2, -3:2, 1:3, &
   &            sps) + x2b(-3:2, -3:2, 1:3)
   x2b(-3:2, -3:2, 1:3) = 0.0
   xadjb(0, -3:2, -3:2, 1:3, sps) = xadjb(0, -3:2, -3:2, 1:3, sps&
   &            ) + x1b(-3:2, -3:2, 1:3)
   x1b(-3:2, -3:2, 1:3) = 0.0
   xadjb(1, -3:2, -3:2, 1:3, sps) = xadjb(1, -3:2, -3:2, 1:3, sps&
   &            ) + x0b(-3:2, -3:2, 1:3)
   x0b(-3:2, -3:2, 1:3) = 0.0
   GOTO 110
   END IF
   xblockcorneradjb(1, :, :, :, sps) = xblockcorneradjb(1, :, :, :&
   &          , sps) + xfacecornerb(:, :, :)
   xfacecornerb(:, :, :) = 0.0
   GOTO 180
   ELSE
   ...
   GOTO 110
   ELSE
   xadjb(-3:2, 0, -3:2, 1:3, sps) = xadjb(-3:2, 0, -3:2, 1:3, &
   &              sps) + x2b(-3:2, -3:2, 1:3)
   x2b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-3:2, -1, -3:2, 1:3, sps) = xadjb(-3:2, -1, -3:2, 1:3&
   &              , sps) + x1b(-3:2, -3:2, 1:3)
   x1b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-3:2, -2, -3:2, 1:3, sps) = xadjb(-3:2, -2, -3:2, 1:3&
   &              , sps) + x0b(-3:2, -3:2, 1:3)
   x0b(-3:2, -3:2, 1:3) = 0.0
   END IF
   ELSE
   ...
   &            sps) + x1b(-3:2, -3:2, 1:3)
   x1b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-3:2, -3, -3:2, 1:3, sps) = xadjb(-3:2, -3, -3:2, 1:3, &
   &            sps) + x0b(-3:2, -3:2, 1:3)
   x0b(-3:2, -3:2, 1:3) = 0.0
   END IF
   xblockcorneradjb(:, 1, :, :, sps) = xblockcorneradjb(:, 1, :, :&
   ...
   GOTO 160
   END IF
   110  xblockcorneradjb(2, :, :, :, sps) = xblockcorneradjb(2, :, :, :, &
   &        sps) + xfacecornerb(:, :, :)
   xfacecornerb(:, :, :) = 0.0
   GOTO 170
   ELSE
   ...
   x0b(-3:2, -3:2, 1:3) = 0.0
   END IF
   xblockcorneradjb(:, 2, :, :, sps) = xblockcorneradjb(:, 2, :, &
   &            :, sps) + xfacecornerb(:, :, :)
   xfacecornerb(:, :, :) = 0.0
   GOTO 150
   ELSE
   xadjb(-3:2, -3:2, 0, 1:3, sps) = xadjb(-3:2, -3:2, 0, 1:3, sps&
   &            ) + x2b(-3:2, -3:2, 1:3)
   x2b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-3:2, -3:2, -1, 1:3, sps) = xadjb(-3:2, -3:2, -1, 1:3, &
   &            sps) + x1b(-3:2, -3:2, 1:3)
   x1b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-3:2, -3:2, -2, 1:3, sps) = xadjb(-3:2, -3:2, -2, 1:3, &
   &            sps) + x0b(-3:2, -3:2, 1:3)
   x0b(-3:2, -3:2, 1:3) = 0.0
   END IF
   ELSE
   ...
   &              , sps) + x1b(-3:2, -3:2, 1:3)
   x1b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-3:2, -3:2, -3, 1:3, sps) = xadjb(-3:2, -3:2, -3, 1:3&
   &              , sps) + x0b(-3:2, -3:2, 1:3)
   x0b(-3:2, -3:2, 1:3) = 0.0
   GOTO 120
   ELSE
   ...
   &              , sps) + x2b(-3:2, -3:2, 1:3)
   x2b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-3:2, -3:2, 0, 1:3, sps) = xadjb(-3:2, -3:2, 0, 1:3, &
   &              sps) + x1b(-3:2, -3:2, 1:3)
   x1b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-3:2, -3:2, 1, 1:3, sps) = xadjb(-3:2, -3:2, 1, 1:3, &
   &              sps) + x0b(-3:2, -3:2, 1:3)
   ...
   &            ) + x2b(-3:2, -3:2, 1:3)
   x2b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-3:2, -3:2, 1, 1:3, sps) = xadjb(-3:2, -3:2, 1, 1:3, sps&
   &            ) + x1b(-3:2, -3:2, 1:3)
   x1b(-3:2, -3:2, 1:3) = 0.0
   xadjb(-3:2, -3:2, 2, 1:3, sps) = xadjb(-3:2, -3:2, 2, 1:3, sps&
   &            ) + x0b(-3:2, -3:2, 1:3)
   x0b(-3:2, -3:2, 1:3) = 0.0
   END IF
   xblockcorneradjb(:, :, 2, :, sps) = xblockcorneradjb(:, :, 2, :&
   ...
   GOTO 130
   END IF
   120  xblockcorneradjb(:, :, 1, :, sps) = xblockcorneradjb(:, :, 1, :, &
   &        sps) + xfacecornerb(:, :, :)
   xfacecornerb(:, :, :) = 0.0
   GOTO 140
   END IF
   ...
   CALL POPINTEGER4(branch)
   IF (.NOT.branch .LT. 3) THEN
   xadjb(i, j, kmaxoffset-1, 3, sps) = xadjb(i, j, kmaxoffset-1&
   &              , 3, sps) + two*xadjb(i, j, kmaxoffset, 3, sps)
   xadjb(i, j, kmaxoffset-2, 3, sps) = xadjb(i, j, kmaxoffset-2&
   &              , 3, sps) - xadjb(i, j, kmaxoffset, 3, sps)
   xadjb(i, j, kmaxoffset, 3, sps) = 0.0
   xadjb(i, j, kmaxoffset-1, 2, sps) = xadjb(i, j, kmaxoffset-1&
   &              , 2, sps) + two*xadjb(i, j, kmaxoffset, 2, sps)
   xadjb(i, j, kmaxoffset-2, 2, sps) = xadjb(i, j, kmaxoffset-2&
   &              , 2, sps) - xadjb(i, j, kmaxoffset, 2, sps)
   xadjb(i, j, kmaxoffset, 2, sps) = 0.0
   xadjb(i, j, kmaxoffset-1, 1, sps) = xadjb(i, j, kmaxoffset-1&
   &              , 1, sps) + two*xadjb(i, j, kmaxoffset, 1, sps)
   xadjb(i, j, kmaxoffset-2, 1, sps) = xadjb(i, j, kmaxoffset-2&
   &              , 1, sps) - xadjb(i, j, kmaxoffset, 1, sps)
   xadjb(i, j, kmaxoffset, 1, sps) = 0.0
   END IF
   END DO
   END DO
   END IF
   ...
   CALL POPINTEGER4(branch)
   IF (.NOT.branch .LT. 3) THEN
   xadjb(i, j, kminoffset+1, 3, sps) = xadjb(i, j, kminoffset+1&
   &              , 3, sps) + two*xadjb(i, j, kminoffset, 3, sps)
   xadjb(i, j, kminoffset+2, 3, sps) = xadjb(i, j, kminoffset+2&
   &              , 3, sps) - xadjb(i, j, kminoffset, 3, sps)
   xadjb(i, j, kminoffset, 3, sps) = 0.0
   xadjb(i, j, kminoffset+1, 2, sps) = xadjb(i, j, kminoffset+1&
   &              , 2, sps) + two*xadjb(i, j, kminoffset, 2, sps)
   xadjb(i, j, kminoffset+2, 2, sps) = xadjb(i, j, kminoffset+2&
   &              , 2, sps) - xadjb(i, j, kminoffset, 2, sps)
   xadjb(i, j, kminoffset, 2, sps) = 0.0
   xadjb(i, j, kminoffset+1, 1, sps) = xadjb(i, j, kminoffset+1&
   &              , 1, sps) + two*xadjb(i, j, kminoffset, 1, sps)
   xadjb(i, j, kminoffset+2, 1, sps) = xadjb(i, j, kminoffset+2&
   &              , 1, sps) - xadjb(i, j, kminoffset, 1, sps)
   xadjb(i, j, kminoffset, 1, sps) = 0.0
   END IF
   END DO
   END DO
   END IF
   ...
   CALL POPINTEGER4(branch)
   IF (.NOT.branch .LT. 3) THEN
   xadjb(i, jmaxoffset-1, k, 3, sps) = xadjb(i, jmaxoffset-1, k&
   &              , 3, sps) + two*xadjb(i, jmaxoffset, k, 3, sps)
   xadjb(i, jmaxoffset-2, k, 3, sps) = xadjb(i, jmaxoffset-2, k&
   &              , 3, sps) - xadjb(i, jmaxoffset, k, 3, sps)
   xadjb(i, jmaxoffset, k, 3, sps) = 0.0
   xadjb(i, jmaxoffset-1, k, 2, sps) = xadjb(i, jmaxoffset-1, k&
   &              , 2, sps) + two*xadjb(i, jmaxoffset, k, 2, sps)
   xadjb(i, jmaxoffset-2, k, 2, sps) = xadjb(i, jmaxoffset-2, k&
   &              , 2, sps) - xadjb(i, jmaxoffset, k, 2, sps)
   xadjb(i, jmaxoffset, k, 2, sps) = 0.0
   xadjb(i, jmaxoffset-1, k, 1, sps) = xadjb(i, jmaxoffset-1, k&
   &              , 1, sps) + two*xadjb(i, jmaxoffset, k, 1, sps)
   xadjb(i, jmaxoffset-2, k, 1, sps) = xadjb(i, jmaxoffset-2, k&
   &              , 1, sps) - xadjb(i, jmaxoffset, k, 1, sps)
   xadjb(i, jmaxoffset, k, 1, sps) = 0.0
   END IF
   END DO
   END DO
   END IF
   ...
   CALL POPINTEGER4(branch)
   IF (.NOT.branch .LT. 3) THEN
   xadjb(i, jminoffset+1, k, 3, sps) = xadjb(i, jminoffset+1, k&
   &              , 3, sps) + two*xadjb(i, jminoffset, k, 3, sps)
   xadjb(i, jminoffset+2, k, 3, sps) = xadjb(i, jminoffset+2, k&
   &              , 3, sps) - xadjb(i, jminoffset, k, 3, sps)
   xadjb(i, jminoffset, k, 3, sps) = 0.0
   xadjb(i, jminoffset+1, k, 2, sps) = xadjb(i, jminoffset+1, k&
   &              , 2, sps) + two*xadjb(i, jminoffset, k, 2, sps)
   xadjb(i, jminoffset+2, k, 2, sps) = xadjb(i, jminoffset+2, k&
   &              , 2, sps) - xadjb(i, jminoffset, k, 2, sps)
   xadjb(i, jminoffset, k, 2, sps) = 0.0
   xadjb(i, jminoffset+1, k, 1, sps) = xadjb(i, jminoffset+1, k&
   &              , 1, sps) + two*xadjb(i, jminoffset, k, 1, sps)
   xadjb(i, jminoffset+2, k, 1, sps) = xadjb(i, jminoffset+2, k&
   &              , 1, sps) - xadjb(i, jminoffset, k, 1, sps)
   xadjb(i, jminoffset, k, 1, sps) = 0.0
   END IF
   END DO
   END DO
   END IF
   ...
   CALL POPINTEGER4(branch)
   IF (.NOT.branch .LT. 3) THEN
   xadjb(imaxoffset-1, j, k, 3, sps) = xadjb(imaxoffset-1, j, k&
   &              , 3, sps) + two*xadjb(imaxoffset, j, k, 3, sps)
   xadjb(imaxoffset-2, j, k, 3, sps) = xadjb(imaxoffset-2, j, k&
   &              , 3, sps) - xadjb(imaxoffset, j, k, 3, sps)
   xadjb(imaxoffset, j, k, 3, sps) = 0.0
   xadjb(imaxoffset-1, j, k, 2, sps) = xadjb(imaxoffset-1, j, k&
   &              , 2, sps) + two*xadjb(imaxoffset, j, k, 2, sps)
   xadjb(imaxoffset-2, j, k, 2, sps) = xadjb(imaxoffset-2, j, k&
   &              , 2, sps) - xadjb(imaxoffset, j, k, 2, sps)
   xadjb(imaxoffset, j, k, 2, sps) = 0.0
   xadjb(imaxoffset-1, j, k, 1, sps) = xadjb(imaxoffset-1, j, k&
   &              , 1, sps) + two*xadjb(imaxoffset, j, k, 1, sps)
   xadjb(imaxoffset-2, j, k, 1, sps) = xadjb(imaxoffset-2, j, k&
   &              , 1, sps) - xadjb(imaxoffset, j, k, 1, sps)
   xadjb(imaxoffset, j, k, 1, sps) = 0.0
   END IF
   END DO
   END DO
   END IF
   ...
   CALL POPINTEGER4(branch)
   IF (.NOT.branch .LT. 3) THEN
   xadjb(iminoffset+1, j, k, 3, sps) = xadjb(iminoffset+1, j, k&
   &              , 3, sps) + two*xadjb(iminoffset, j, k, 3, sps)
   xadjb(iminoffset+2, j, k, 3, sps) = xadjb(iminoffset+2, j, k&
   &              , 3, sps) - xadjb(iminoffset, j, k, 3, sps)
   xadjb(iminoffset, j, k, 3, sps) = 0.0
   xadjb(iminoffset+1, j, k, 2, sps) = xadjb(iminoffset+1, j, k&
   &              , 2, sps) + two*xadjb(iminoffset, j, k, 2, sps)
   xadjb(iminoffset+2, j, k, 2, sps) = xadjb(iminoffset+2, j, k&
   &              , 2, sps) - xadjb(iminoffset, j, k, 2, sps)
   xadjb(iminoffset, j, k, 2, sps) = 0.0
   xadjb(iminoffset+1, j, k, 1, sps) = xadjb(iminoffset+1, j, k&
   &              , 1, sps) + two*xadjb(iminoffset, j, k, 1, sps)
   xadjb(iminoffset+2, j, k, 1, sps) = xadjb(iminoffset+2, j, k&
   &              , 1, sps) - xadjb(iminoffset, j, k, 1, sps)
   xadjb(iminoffset, j, k, 1, sps) = 0.0
   END IF
   END DO
   END DO
   END IF
