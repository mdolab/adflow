...
!      ******************************************************************
!
subroutine bcSymmForceCouplingAdj(secondHalo, wAdj,pAdj,normAdj,nn,&
...
!!$                                rev1, rev2, mm)
     ...
     call extractBCStatesForceCouplingAdj(nn,wAdj,pAdj,wAdj0, wAdj1, wAdj2,wAdj3,&
...
!!$              if( eddyModel ) revAdj1(i,j) = revAdj2(i,j)
     ...
     call replaceBCStatesForceCouplingAdj(nn,  wAdj0,wAdj1, wAdj2, wAdj3,&
...
end subroutine bcSymmForceCouplingAdj
