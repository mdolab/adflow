...
!      ******************************************************************
!
       subroutine checkInputParamForceCouplingAdj(velDirFreestreamAdj,liftDirectionAdj,&
...
!
       ...
       real(kind=realType), intent(inout) :: MachAdj,MachCoefAdj
...
!!$       endif
       ...
       if(liftDirSpecified .and. flowType == externalFlow) then
         ...
         vecLength = sqrt(liftDirectionAdj(1)*liftDirectionAdj(1) &
                   +      liftDirectionAdj(2)*liftDirectionAdj(2) &
         ...
         liftDirectionAdj(3) = liftDirectionAdj(3)*vecLength

         ! Check the orthogonality with the drag direction.

         dot = liftDirectionAdj(1)*dragDirectionAdj(1) &
             + liftDirectionAdj(2)*dragDirectionAdj(2) &
             + liftDirectionAdj(3)*dragDirectionAdj(3)
         ...
         if(liftDirectionAdj(3) < zero) then
           liftDirectionAdj(1) = -liftDirectionAdj(1)
           liftDirectionAdj(3) = -liftDirectionAdj(3)
         endif
       endif
...
!!$       velDirIni(3) = velDirIni(3)*vecLength
       ...
       if(MachCoefAdj < zero) MachCoefAdj = MachAdj
!!$!
!!$!      ******************************************************************
!!$!      *                                                                *
...
!!$       endif
     ...
     end subroutine checkInputParamForceCouplingAdj
