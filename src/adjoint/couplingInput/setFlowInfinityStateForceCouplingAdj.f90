...
!      ******************************************************************
!
       subroutine setFlowInfinityStateForceCouplingAdj(velDirFreestreamAdj,liftDirectionAdj,&
...
!                       wInfAdj(irhoE), kPresent, 1_intType)
       call etotArrayForceCouplingAdj(rhoInfAdj, uInfAdj, vtmp, wtmp, pInfCorrAdj, ktmp, &
                   wInfAdj(irhoE), kPresent, 1)

     end subroutine setFlowInfinityStateForceCouplingAdj
