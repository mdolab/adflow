...
!      ******************************************************************
!
subroutine bcFarfieldForceCouplingAdj(secondHalo,wInfAdj,pInfCorrAdj, wAdj,pAdj,&
  ...
  !      ******************************************************************
  !
  use blockPointers, only : BCData,nBocos,BCType,bcfaceid,gamma,il,jl,kl,w,p,ib,jb,kb
...
!
  ...
  testFarfield: if(BCType(mm) == FarField) then
     
     call extractBCStatesForceCouplingAdj(mm,wAdj,pAdj,wAdj0, wAdj1, wAdj2,wAdj3,&
...
!        do i=icBeg, icEnd
     ...
     if( secondHalo )                                             &
          call extrapolate2ndHaloForceCouplingAdj(mm,iiBeg, iiEnd, jjBeg, jjEnd,  &
          wAdj0, wAdj1, &
          wAdj2, pAdj0, pAdj1, pAdj2)
     
     call replaceBCStatesForceCouplingAdj(mm,  wAdj0,wAdj1, wAdj2, wAdj3,&
...
end subroutine bcFarfieldForceCouplingAdj
