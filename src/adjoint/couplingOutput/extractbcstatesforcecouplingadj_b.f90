...
!  
!  Differentiation of extractbcstatesforcecouplingadj in reverse (adjoint) mode:
...
!      ******************************************************************
!
SUBROUTINE EXTRACTBCSTATESFORCECOUPLINGADJ_B(nn, wadj, wadjb, padj, &
&  padjb, wadj0, wadj0b, wadj1, wadj1b, wadj2, wadj2b, wadj3, wadj3b, &
&  padj0, padj0b, padj1, padj1b, padj2, padj2b, padj3, padj3b, rlvadj, &
&  revadj, rlvadj1, rlvadj2, revadj1, revadj2, icbeg, jcbeg, icend, &
&  jcend, secondhalo)
...
&        jcbeg:jcend, kb, 1:nw) + wadj1b(icbeg:icend, jcbeg:jcend, 1:nw)
    END IF
  END SELECT
END SUBROUTINE EXTRACTBCSTATESFORCECOUPLINGADJ_B
