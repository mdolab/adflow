...
!  
!  Differentiation of extrapolate2ndhaloforcecouplingadj in reverse (adjoint) mode:
...
!      ******************************************************************
!
SUBROUTINE EXTRAPOLATE2NDHALOFORCECOUPLINGADJ_B(nn, icbeg, icend, jcbeg&
&  , jcend, wadj0, wadj0b, wadj1, wadj1b, wadj2, wadj2b, padj0, padj0b, &
...
&        irho)
    ...
    END DO
  END DO
END SUBROUTINE EXTRAPOLATE2NDHALOFORCECOUPLINGADJ_B
