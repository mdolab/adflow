...
!  
!  Differentiation of checkinputparamforcecouplingadj in reverse (adjoint) mode:
!   gradient, with respect to input variables: veldirfreestreamadj
...
!      ******************************************************************
!
SUBROUTINE CHECKINPUTPARAMFORCECOUPLINGADJ_B(veldirfreestreamadj, &
...
!!$       endif
  ...
  REAL(KIND=REALTYPE) :: abs1, dot, tempb, veclength, veclengthb
  INTRINSIC ABS, SQRT
...
&      veldirfreestreamadj(3)*tempb
  ...
  END IF
END SUBROUTINE CHECKINPUTPARAMFORCECOUPLINGADJ_B
