...
!  
!  Differentiation of setflowinfinitystateforcecouplingadj in reverse (adjoint) mode:
...
!      ******************************************************************
!
SUBROUTINE SETFLOWINFINITYSTATEFORCECOUPLINGADJ_B(veldirfreestreamadj, &
...
! add 2/3 times rho*k.
  ...
  ELSE
    CALL PUSHINTEGER4(0)
  END IF
  CALL ETOTARRAYFORCECOUPLINGADJ_B(rhoinfadj, uinfadj, uinfadjb, vtmp, &
&                             wtmp, pinfcorradj, pinfcorradjb, ktmp, &
&                             winfadj(irhoe), winfadjb(irhoe), kpresent&
&                             , 1)
...
&    ivx)
END SUBROUTINE SETFLOWINFINITYSTATEFORCECOUPLINGADJ_B
