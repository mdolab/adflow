...
!  
!  Differentiation of eintarrayforcecouplingadj in reverse (adjoint) mode:
!   gradient, with respect to input variables: p eint gammaconstant
!   of linear combination of output variables: p eint
!      ==================================================================
SUBROUTINE EINTARRAYFORCECOUPLINGADJ_B(rho, p, pb, k, eint, eintb, &
&  correctfork, kk)
  USE constants
  USE flowvarrefstate
  USE inputphysics
...
! energy is present.
  ...
  END SELECT
!  gammaconstantb = 0.0
END SUBROUTINE EINTARRAYFORCECOUPLINGADJ_B
