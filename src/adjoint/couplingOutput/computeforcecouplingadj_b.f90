...
!   gradient, with respect to input variables: pts wadj force
...
! Compute the pressure in the 2x2x2 block
  ...
  CALL FORCESCOUPLINGADJ_B(padj, padjb, pts, normadj, normadjb, force, &
&                     forceb, fact, ibeg, iend, jbeg, jend, inode, jnode)
  forceb = 0.0
