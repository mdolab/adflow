...
!      ******************************************************************
!
       subroutine applyAllBCAdjTS(wInfAdj,pInfCorrAdj,wAdj, pAdj,sAdj, &
...
!*************************
       call bcSymmAdjTS(wAdj,pAdj,normAdj,iCell,jCell,kCell,secondHalo,nn,level,sps)
...
!*******************************
       ...
       case (noPrecond)
          ...
          call bcFarfieldAdjTS(secondHalo,wInfAdj,pInfCorrAdj, wAdj,pAdj,      &
...
!!$       
       ...
       call bcEulerWallAdjTS(secondHalo, wAdj,pAdj,sAdj,      &
            siAdj, sjAdj, skAdj, normAdj,rFaceAdj,iCell,jCell,kCell,nn,level,sps)
...
!!$       enddo spectralLoop
     ...
     end subroutine applyAllBCAdjTS
