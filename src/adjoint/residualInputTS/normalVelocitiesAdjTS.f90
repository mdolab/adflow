...
!      ******************************************************************
!
       subroutine normalVelocitiesAllLevelsAdjTS(sps,iCell, jCell, kCell,sFaceIAdj,&
                 ...
                 select case (BCFaceID(mm))
                   ...
                   case (iMin)
                      ...
                      if(secondHalo)then
                         ...
                         sFaceAdj(iSt:iEn,jSt:jEn)= sFaceIAdj(-1,iSt:iEn,jSt:jEn,sps)
                      else 
                         mult = -one
                         ss(iSt:iEn,jSt:jEn,:) = siAdj(-2,iSt:iEn,jSt:jEn,:,sps)
                         sFaceAdj(iSt:iEn,jSt:jEn)= sFaceIAdj(-2,iSt:iEn,jSt:jEn,sps)
                      end if
                   ...
                   case (iMax)
                      ...
                      if(secondHalo) then
                         ...
                         sFaceAdj(iSt:iEn,jSt:jEn) = sFaceIAdj(0,iSt:iEn,jSt:jEn,sps)
                      else
                         mult = one
                         ss(iSt:iEn,jSt:jEn,:) = siAdj(1,iSt:iEn,jSt:jEn,:,sps)
                         sFaceAdj(iSt:iEn,jSt:jEn) = sFaceIAdj(1,iSt:iEn,jSt:jEn,sps)
                   ...
                   case (jMin)
                      ...
                      if(secondHalo) then
                         ...
                         sFaceAdj(iSt:iEn,jSt:jEn) = sFaceJAdj(iSt:iEn,-1,jSt:jEn,sps)
                      else
                         mult = -one
                         ss(iSt:iEn,jSt:jEn,:) = sjAdj(iSt:iEn,-2,jSt:jEn,:,sps)
                         sFaceAdj(iSt:iEn,jSt:jEn) = sFaceJAdj(iSt:iEn,-2,jSt:jEn,sps)
                      end if
                   ...
                   case (jMax)
                      ...
                      if(secondHalo) then
                         ...
                         sFaceAdj(iSt:iEn,jSt:jEn) = sFaceJAdj(iSt:iEn,0,jSt:jEn,sps)
                      else
                         mult = one
                         ss(iSt:iEn,jSt:jEn,:) = sjAdj(iSt:iEn,1,jSt:jEn,:,sps)
                         sFaceAdj(iSt:iEn,jSt:jEn) = sFaceJAdj(iSt:iEn,1,jSt:jEn,sps)
                   ...
                   case (kMin)
                      ...
                      if(secondHalo) then
                         ...
                         sFaceAdj(iSt:iEn,jSt:jEn) = sFaceKAdj(iSt:iEn,jSt:jEn,-1,sps)
                      else
                         mult = -one
                         ss(iSt:iEn,jSt:jEn,:) = skAdj(iSt:iEn,jSt:jEn,-2,:,sps)
                         sFaceAdj(iSt:iEn,jSt:jEn) = sFaceKAdj(iSt:iEn,jSt:jEn,-2,sps)
                      end if
                   ...
                   case (kMax)
                      ...
                      if(secondHalo) then
                         ...
                         sFaceAdj(iSt:iEn,jSt:jEn) = sFaceKAdj(iSt:iEn,jSt:jEn,0,sps)
                      else
                         mult = one
                         ss(iSt:iEn,jSt:jEn,:) = skAdj(iSt:iEn,jSt:jEn,1,:,sps)
                         sFaceAdj(iSt:iEn,jSt:jEn) = sFaceKAdj(iSt:iEn,jSt:jEn,1,sps)
                 ...
                 !  do i=icBeg, icEnd
                     ...
                     ! vector and possibly correct for inward pointing.
                       if( ss(ii,jj,1)**2>zero .or. ss(ii,jj,2)**2>zero&
                          ...
                          rFaceAdj(mm,ii,jj,sps) = weight*sFaceAdj(ii,jj)
...
!       enddo levelLoop
         ...
         end subroutine normalVelocitiesAllLevelsAdjTS
