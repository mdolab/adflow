...
!     ******************************************************************
!
      subroutine getDirVectorTS(refDirection, alpha, beta,&
...
!!$      call vectorRotation(xw, yw, zw, 3, -beta, x1, y1, z1)
      ...
      if (liftIndex==2)then
         ...
         call vectorRotationTS(x1, y1, z1, 3, -alpha, xbn, ybn, zbn)
         
         ! 2) rotate beta radians ccw about y-axis
         !    ( <=> rotate z-axis -beta radians ccw)
         
         call vectorRotationTS(xw, yw, zw, 2, -beta, x1, y1, z1)
      ...
      elseif(liftIndex==3)then
         ...
         call vectorRotationTS(x1, y1, z1, 2, alpha, xbn, ybn, zbn)
         
         ! 2) rotate beta radians ccw about y-axis
         !    ( <=> rotate z-axis -beta radians ccw)
         
         call vectorRotationTS(xw, yw, zw, 3, beta, x1, y1, z1)
