...
!
         ...
         subroutine riemannFluxAdjTS(left, right, flux,por,gammaFace,correctForK,sX,sY,sZ,sFace,fineGrid)
!
!        ****************************************************************
!        *                                                              *
...
!                                Etmp, correctForK, 2_intType)
                 call etotArrayAdjTS(rhotmp, utmp, vtmp, wtmp, ptmp, ktmp, &
                                Etmp, correctForK, 2)
      ...
      !          flux(irhoE) = -porFlux*(tmp*drE)
       ...
       end subroutine riemannFluxAdjTS
