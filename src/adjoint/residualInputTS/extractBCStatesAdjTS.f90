...
!      ******************************************************************
!
       subroutine extractBCStatesAdjTS(nn,wAdj,pAdj,wAdj0, wAdj1, wAdj2,wAdj3,&
            ...
            jbend,kbend,icbeg,jcbeg,icend,jcend,secondHalo,nnn,level,sps)
...
!
       integer(kind=intType), intent(in) :: nn,nnn,level,sps!, offset
...
!!$             jcEnd = min(kREnd,kCell+1)
             ...
             if( secondHalo ) then
                wAdj0(-2:2,-2:2,1:nw) = wAdj(-2,-2:2,-2:2,1:nw,sps)
                wAdj1(-2:2,-2:2,1:nw) = wAdj(-1,-2:2,-2:2,1:nw,sps)
                wAdj2(-2:2,-2:2,1:nw) = wAdj( 0,-2:2,-2:2,1:nw,sps)
                wAdj3(-2:2,-2:2,1:nw) = wAdj( 1,-2:2,-2:2,1:nw,sps)
                
                pAdj0(-2:2,-2:2) = pAdj(-2,-2:2,-2:2,sps)
                pAdj1(-2:2,-2:2) = pAdj(-1,-2:2,-2:2,sps)
                pAdj2(-2:2,-2:2) = pAdj( 0,-2:2,-2:2,sps)
                pAdj3(-2:2,-2:2) = pAdj( 1,-2:2,-2:2,sps)
                ...
                wAdj1(-2:2,-2:2,1:nw) = wAdj(-2,-2:2,-2:2,1:nw,sps)
                wAdj2(-2:2,-2:2,1:nw) = wAdj(-1,-2:2,-2:2,1:nw,sps)
                wAdj3(-2:2,-2:2,1:nw) = wAdj( 0,-2:2,-2:2,1:nw,sps)
                
                pAdj1(-2:2,-2:2) = pAdj(-2,-2:2,-2:2,sps)
                pAdj2(-2:2,-2:2) = pAdj(-1,-2:2,-2:2,sps)
                pAdj3(-2:2,-2:2) = pAdj( 0,-2:2,-2:2,sps)
...
!!$             jcEnd = min(kREnd,kCell+1)
          ...
          case (jMin)
             ...
             if( secondHalo ) then
                wAdj0(-2:2,-2:2,1:nw) = wAdj(-2:2,-2,-2:2,1:nw,sps)
                wAdj1(-2:2,-2:2,1:nw) = wAdj(-2:2,-1,-2:2,1:nw,sps)
                wAdj2(-2:2,-2:2,1:nw) = wAdj(-2:2, 0,-2:2,1:nw,sps)
                wAdj3(-2:2,-2:2,1:nw) = wAdj(-2:2, 1,-2:2,1:nw,sps)
                
                pAdj0(-2:2,-2:2) = pAdj(-2:2,-2,-2:2,sps)
                pAdj1(-2:2,-2:2) = pAdj(-2:2,-1,-2:2,sps)
                pAdj2(-2:2,-2:2) = pAdj(-2:2, 0,-2:2,sps)
                pAdj3(-2:2,-2:2) = pAdj(-2:2, 1,-2:2,sps)
                ...
                wAdj1(-2:2,-2:2,1:nw) = wAdj(-2:2,-2,-2:2,1:nw,sps)
                wAdj2(-2:2,-2:2,1:nw) = wAdj(-2:2,-1,-2:2,1:nw,sps)
                wAdj3(-2:2,-2:2,1:nw) = wAdj(-2:2, 0,-2:2,1:nw,sps)
                
                pAdj1(-2:2,-2:2) = pAdj(-2:2,-2,-2:2,sps)
                pAdj2(-2:2,-2:2) = pAdj(-2:2,-1,-2:2,sps)
                pAdj3(-2:2,-2:2) = pAdj(-2:2, 0,-2:2,sps)
...
!!$             jcEnd = min(jREnd,jCell+1)
             ...
             if( secondHalo ) then
                wAdj0(-2:2,-2:2,1:nw) = wAdj(-2:2,-2:2,-2,1:nw,sps)
                wAdj1(-2:2,-2:2,1:nw) = wAdj(-2:2,-2:2,-1,1:nw,sps)
                wAdj2(-2:2,-2:2,1:nw) = wAdj(-2:2,-2:2, 0,1:nw,sps)
                wAdj3(-2:2,-2:2,1:nw) = wAdj(-2:2,-2:2, 1,1:nw,sps)
                
                pAdj0(-2:2,-2:2) = pAdj(-2:2,-2:2,-2,sps)
                pAdj1(-2:2,-2:2) = pAdj(-2:2,-2:2,-1,sps)
                pAdj2(-2:2,-2:2) = pAdj(-2:2,-2:2, 0,sps)
                pAdj3(-2:2,-2:2) = pAdj(-2:2,-2:2, 1,sps)
                ...
                wAdj1(-2:2,-2:2,1:nw) = wAdj(-2:2,-2:2,-2,1:nw,sps)
                wAdj2(-2:2,-2:2,1:nw) = wAdj(-2:2,-2:2,-1,1:nw,sps)
                wAdj3(-2:2,-2:2,1:nw) = wAdj(-2:2,-2:2, 0,1:nw,sps)
                
                pAdj1(-2:2,-2:2) = pAdj(-2:2,-2:2,-2,sps)
                pAdj2(-2:2,-2:2) = pAdj(-2:2,-2:2,-1,sps)
                pAdj3(-2:2,-2:2) = pAdj(-2:2,-2:2, 0,sps)
...
!          print *,'offsets',ioffset,joffset
        end subroutine extractBCStatesAdjTS
