...
!      ******************************************************************
!
       subroutine derivativeRotMatrixRigidAdjTS(rotationMatrixAdj, &
...
!
       ...
       real(kind=realType) :: derivativeRigidRotAngleAdj
!
!      ******************************************************************
!      *                                                                *
!      * Begin execution                                                *
...
!
       ...
       phi = rigidRotAngleAdj(degreePolXRot,   coefPolXRot,      &
       ...
       phi = rigidRotAngleAdj(degreePolYRot,   coefPolYRot,      &
       ...
       phi = rigidRotAngleAdj(degreePolZRot,   coefPolZRot,      &
       ...
       dphiX = derivativeRigidRotAngleAdj(degreePolXRot,   &
                                       coefPolXRot,     &
                                       degreeFourXRot,  &
                                       omegaFourXRot,   &
                                       cosCoefFourXRot, &
       ...
       dphiY = derivativeRigidRotAngleAdj(degreePolYRot,   &
                                       coefPolYRot,     &
                                       degreeFourYRot,  &
                                       omegaFourYRot,   &
                                       cosCoefFourYRot, &
       ...
       dphiZ = derivativeRigidRotAngleAdj(degreePolZRot,   &
                                       coefPolZRot,     &
                                       degreeFourZRot,  &
                                       omegaFourZRot,   &
                                       cosCoefFourZRot, &
    ...
    !                    + MachGrid(3)*aInf*t/timeRef
     ...
     end subroutine derivativeRotMatrixRigidAdjTS
