...
!      ******************************************************************
!
       subroutine setFlowInfinityStateAdjTS(velDirFreestreamAdj,liftDirectionAdj,&
...
!                       wInfAdj(irhoE), kPresent, 1_intType)
       call etotArrayAdjTS(rhoInfAdj, uInfAdj, vtmp, wtmp, pInfCorrAdj, ktmp, &
                   wInfAdj(irhoE), kPresent, 1)

     end subroutine setFlowInfinityStateAdjTS
