...
!      ******************************************************************
!
       subroutine replaceBCStatesAdjTS(nn,  wAdj0,wAdj1, wAdj2, wAdj3,&
...
!      modules
       ...
       integer(kind=intType), intent(in) :: nn,nnn,level,sps
       ...
       case (iMin)
          ...
          if( secondHalo ) then
             ...
             wAdj(-2,-2:2,-2:2,1:nw,sps) = wAdj0(-2:2,-2:2,1:nw) 
             wAdj(-1,-2:2,-2:2,1:nw,sps) = wAdj1(-2:2,-2:2,1:nw)
             
             pAdj(-2,-2:2,-2:2,sps) = pAdj0(-2:2,-2:2) 
             pAdj(-1,-2:2,-2:2,sps) = pAdj1(-2:2,-2:2) 
             ...
             wAdj(-2,-2:2,-2:2,1:nw,sps) = wAdj1(-2:2,-2:2,1:nw)
             pAdj(-2,-2:2,-2:2,sps)      = pAdj1(-2:2,-2:2)
          endif
       ...
       case (jMin)
          ...
          if( secondHalo ) then
             wAdj(-2:2,-2,-2:2,1:nw,sps) = wAdj0(-2:2,-2:2,1:nw)
             wAdj(-2:2,-1,-2:2,1:nw,sps) = wAdj1(-2:2,-2:2,1:nw)
             
             pAdj(-2:2,-2,-2:2,sps) = pAdj0(-2:2,-2:2)
             pAdj(-2:2,-1,-2:2,sps) = pAdj1(-2:2,-2:2)
          else
             wAdj(-2:2,-2,-2:2,1:nw,sps) = wAdj1(-2:2,-2:2,1:nw)
             pAdj(-2:2,-2,-2:2,sps)      = pAdj1(-2:2,-2:2)
          endif
       ...
       case (kMin)
          ...
          if( secondHalo ) then
             wAdj(-2:2,-2:2,-2,1:nw,sps) = wAdj0(-2:2,-2:2,1:nw)
             wAdj(-2:2,-2:2,-1,1:nw,sps) = wAdj1(-2:2,-2:2,1:nw)

             pAdj(-2:2,-2:2,-2,sps) = pAdj0(-2:2,-2:2)
             pAdj(-2:2,-2:2,-1,sps) = pAdj1(-2:2,-2:2)
          else
             wAdj(-2:2,-2:2,-2,1:nw,sps) = wAdj1(-2:2,-2:2,1:nw)
             pAdj(-2:2,-2:2,-2,sps)      = pAdj1(-2:2,-2:2)
          endif
     ...
     end subroutine replaceBCStatesAdjTS
