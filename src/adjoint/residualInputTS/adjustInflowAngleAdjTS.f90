...
!      ******************************************************************
!
subroutine adjustInflowAngleAdjts(alphaAdj,betaAdj,velDirFreestreamAdj,&
  ...
  refDirection(:) = zero
  refDirection(1) = one
  call getDirVectorTS(refDirection, alphaAdj, betaAdj, velDirFreestreamAdj,&
       liftIndex)
  ...
  refDirection(:) = zero
  refDirection(1) = one
  call getDirVectorTS(refDirection, alphaAdj, betaAdj, dragDirectionAdj(1), &
       liftIndex)
  ...
  call getDirVectorTS(refDirection, alphaAdj, betaAdj,liftDirectionAdj, &
       liftIndex)


end subroutine adjustInflowAngleAdjts
