...
!  
!  Differentiation of etotarrayforcesadj in reverse (adjoint) mode:
...
!      ******************************************************************
!
SUBROUTINE ETOTARRAYFORCESADJ_B(rho, u, ub, v, w, p, pb, k, etot, etotb&
&  , correctfork, kk)
  USE constants
  IMPLICIT NONE
...
! Compute the internal energy for unit mass.
  ...
  END DO
  CALL EINTARRAYFORCESADJ_B(rho, p, pb, k, etot, etotb, correctfork, kk)
END SUBROUTINE ETOTARRAYFORCESADJ_B
