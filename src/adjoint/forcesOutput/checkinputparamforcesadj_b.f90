...
!  
!  Differentiation of checkinputparamforcesadj in reverse (adjoint) mode:
!   gradient, with respect to input variables: machadj liftdirectionadj
!                machcoefadj veldirfreestreamadj
!   of linear combination of output variables: machadj liftdirectionadj
!                dragdirectionadj machcoefadj veldirfreestreamadj
!
!      ******************************************************************
!      *                                                                *
...
!      ******************************************************************
!
SUBROUTINE CHECKINPUTPARAMFORCESADJ_B(veldirfreestreamadj, &
...
!!$       endif
  ...
  REAL(KIND=REALTYPE) :: abs1, dot, tempb, tempb0, veclength, veclengthb
  INTRINSIC ABS, SQRT
  EXTERNAL MPI_BARRIER, TERMINATE
!
!      ******************************************************************
...
! will again be changed in initFlo.
  IF (machcoefadj .LT. zero) THEN
    machadjb = machadjb + machcoefadjb
    machcoefadjb = 0.0
  END IF
...
&        )*tempb0
 ...
 100 veldirfreestreamadjb = veldirfreestreamadjb + dragdirectionadjb
  CALL POPINTEGER4(branch)
  IF (branch .LT. 1) THEN
...
&      veldirfreestreamadj(3)*tempb
  ...
  END IF
END SUBROUTINE CHECKINPUTPARAMFORCESADJ_B
