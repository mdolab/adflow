...
!  
!  Differentiation of referencestateforcesadj in reverse (adjoint) mode:
...
!            murefAdj, timerefAdj)
SUBROUTINE REFERENCESTATEFORCESADJ_B(machadj, machadjb, machcoefadj, &
&  uinfadj, uinfadjb, prefadj, rhorefadj, pinfdimadj, rhoinfdimadj, &
...
! later on.
  pinfdimadj = prefadj
  IF (prefadj .LE. zero) pinfdimadj = 101325.0_realType
...
! not specified, set them to the infinity values.
    IF (prefadj .LE. zero) prefadj = pinfdimadj
    IF (rhorefadj .LE. zero) rhorefadj = rhoinfdimadj
...
! viscosity and gas constant.
  ...
  END IF
END SUBROUTINE REFERENCESTATEFORCESADJ_B
