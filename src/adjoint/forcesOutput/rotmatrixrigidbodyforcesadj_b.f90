   ...
   !  
   !  Differentiation of rotmatrixrigidbodyforcesadj in reverse (adjoint) mode:
   ...
   !      ******************************************************************
   !
   SUBROUTINE ROTMATRIXRIGIDBODYFORCESADJ_B(tnew, told, rotationmatrix, &
   ...
   END SUBROUTINE ROTMATRIXRIGIDBODYFORCESADJ_B
