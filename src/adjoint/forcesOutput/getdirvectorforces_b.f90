...
!     ******************************************************************
!
SUBROUTINE GETDIRVECTORFORCES_B(xb, yb, zb, alpha, alphab, beta, betab, &
&  xw, xwb, yw, ywb, zw, zwb)
  USE constants
  IMPLICIT NONE
!
!     ******************************************************************
...
!    ( <=> rotate z-axis -beta radians ccw)
  arg1 = -beta
  CALL VECTORROTATIONFORCES_B(xw, xwb, yw, ywb, zw, zwb, 2, arg1, arg1b&
&                        , x1, x1b, y1, y1b, z1, z1b)
  CALL POPREAL8(arg1)
  betab = betab - arg1b
  CALL VECTORROTATIONFORCES_B(x1, x1b, y1, y1b, z1, z1b, 3, arg1, arg1b&
