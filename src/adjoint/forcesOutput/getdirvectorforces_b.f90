   ...
   REAL(kind=realtype) :: tmpab, tmpbb
   ...
   IF (branch .EQ. 0) THEN
   tmpbb = 0.0
   CALL VECTORROTATIONFORCES_B(xw, xwb, yw, ywb, zw, zwb, 2, tmpb, &
   &                          tmpbb, x1, x1b, y1, y1b, z1, z1b)
   betab = betab - tmpbb
   tmpab = 0.0
   CALL VECTORROTATIONFORCES_B(x1, x1b, y1, y1b, z1, z1b, 3, tmpa, &
   &                          tmpab, xbn, xbnb, ybn, ybnb, zbn, zbnb)
   alphab = alphab - tmpab
