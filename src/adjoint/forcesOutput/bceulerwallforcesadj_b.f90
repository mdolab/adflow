...
&  siadj, siadjb, sjadj, sjadjb, skadj, skadjb, normadj, normadjb, mm, &
...
!       integer(kind=intType) :: iCell, jCell, kCell
  ...
  REAL(KIND=REALTYPE), DIMENSION(0:2, iibeg:iiend, jjbeg:jjend, 3) :: &
&  siadj
  REAL(KIND=REALTYPE), DIMENSION(0:2, iibeg:iiend, jjbeg:jjend, 3) :: &
&  siadjb
! notice the range of y dim is set 1:2 which corresponds to 1/jl
  REAL(KIND=REALTYPE), DIMENSION(iibeg:iiend, 0:2, jjbeg:jjend, 3) :: &
&  sjadj
  REAL(KIND=REALTYPE), DIMENSION(iibeg:iiend, 0:2, jjbeg:jjend, 3) :: &
&  sjadjb
! notice the range of z dim is set 1:2 which corresponds to 1/kl
  REAL(KIND=REALTYPE), DIMENSION(iibeg:iiend, jjbeg:jjend, 0:2, 3) :: &
&  skadj
  REAL(KIND=REALTYPE), DIMENSION(iibeg:iiend, jjbeg:jjend, 0:2, 3) :: &
&  skadjb
...
!
  ...
  REAL(KIND=REALTYPE) :: dpjb, dpkb, rib, rjb, rkb, qjb, qkb
  REAL(KIND=REALTYPE) :: ux, uy, uz, ovgm1, gm53, factk
  REAL(KIND=REALTYPE) :: uxb, uyb, uzb
  REAL(KIND=REALTYPE) :: rface
  REAL(KIND=REALTYPE), DIMENSION(iibeg:iiend, jjbeg:jjend, 3) :: ssi, &
&  ssj, ssk
...
! boundary condition is used.
  REAL(KIND=REALTYPE), DIMENSION(iibeg:iiend, jjbeg:jjend, 3) :: ssib, &
&  ssjb, sskb
    ...
    ELSE
      ...
      DO k=jcend,jcbeg,-1
        DO j=icend,icbeg,-1
          ...
          qjb = temp1*tempb
          qkb = temp0*tempb
          uxb = skxa*qkb + sjxa*qjb + rxk*temp0b + rxj*temp1b
          rxjb = ux*temp1b
          uyb = skya*qkb + sjya*qjb + ryk*temp0b + ryj*temp1b
          ryjb = uy*temp1b
          uzb = skza*qkb + sjza*qjb + rzk*temp0b + rzj*temp1b
          rzjb = uz*temp1b
          rxkb = ux*temp0b
          rykb = uy*temp0b
          rzkb = uz*temp0b
