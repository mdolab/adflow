...
contains
  ...
  subroutine master_d(wdot, xdot, forcesDot, dwDot, famLists, funcValues, funcValuesd, &
    ...
    use solverutils_d, only : timeStep_Block_d, gridvelocitiesfinelevel_block_d
    ...
    use adjointextra_d, only : slipvelocitiesfinelevel_block_d,normalvelocities_block_d
...
#include <petsc/finclude/petsc.h>
  ...
  subroutine master_b(wbar, xbar, extraBar, forcesBar, dwBar, nState, famLists, &
    ...
    use adjointextra_b, only : slipvelocitiesfinelevel_block_b,normalvelocities_block_b
    ...
    use solverutils_b, only : timeStep_Block_b, gridvelocitiesfinelevel_block_b
