...
!  
!  Differentiation of extrapolate2ndhaloadj in reverse (adjoint) mode:
...
!      ******************************************************************
!
SUBROUTINE EXTRAPOLATE2NDHALOADJ_B(nn, icbeg, icend, jcbeg, jcend, &
...
&        irho)
    ...
    END DO
  END DO
END SUBROUTINE EXTRAPOLATE2NDHALOADJ_B
