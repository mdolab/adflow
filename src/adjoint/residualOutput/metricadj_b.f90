   ...
   CALL POPREAL8(mult)
   ELSE
   sjadjb(ist:ien, -2, jst:jen, :, sps2) = sjadjb(ist:ien, &
   &                  -2, jst:jen, :, sps2) + ssb(ist:ien, jst:jen, :)
   ssb(ist:ien, jst:jen, :) = 0.0
   CALL POPREAL8(mult)
   END IF
   CALL POPINTEGER4(branch)
   ...
   ypb = 0.0
   xpb = 0.0
   CALL VOLPYM2_B(xadj(i, j, n, 1, sps2), xadjb(i, j, n, 1, sps2), xadj&
   &             (i, j, n, 2, sps2), xadjb(i, j, n, 2, sps2), xadj(i, j, n&
   &             , 3, sps2), xadjb(i, j, n, 3, sps2), xadj(l, j, n, 1, sps2&
   &             ), xadjb(l, j, n, 1, sps2), xadj(l, j, n, 2, sps2), xadjb(&
   &             l, j, n, 2, sps2), xadj(l, j, n, 3, sps2), xadjb(l, j, n, &
   &             3, sps2), xadj(l, m, n, 1, sps2), xadjb(l, m, n, 1, sps2)&
   &             , xadj(l, m, n, 2, sps2), xadjb(l, m, n, 2, sps2), xadj(l&
   &             , m, n, 3, sps2), xadjb(l, m, n, 3, sps2), xadj(i, m, n, 1&
   &             , sps2), xadjb(i, m, n, 1, sps2), xadj(i, m, n, 2, sps2), &
   &             xadjb(i, m, n, 2, sps2), xadj(i, m, n, 3, sps2), xadjb(i, &
   &             m, n, 3, sps2), xp, xpb, yp, ypb, zp, zpb, vp6, vp6b)
   CALL VOLPYM2_B(xadj(i, j, k, 1, sps2), xadjb(i, j, k, 1, sps2), xadj&
   &             (i, j, k, 2, sps2), xadjb(i, j, k, 2, sps2), xadj(i, j, k&
   &             , 3, sps2), xadjb(i, j, k, 3, sps2), xadj(i, m, k, 1, sps2&
   &             ), xadjb(i, m, k, 1, sps2), xadj(i, m, k, 2, sps2), xadjb(&
   &             i, m, k, 2, sps2), xadj(i, m, k, 3, sps2), xadjb(i, m, k, &
   &             3, sps2), xadj(l, m, k, 1, sps2), xadjb(l, m, k, 1, sps2)&
   &             , xadj(l, m, k, 2, sps2), xadjb(l, m, k, 2, sps2), xadj(l&
   &             , m, k, 3, sps2), xadjb(l, m, k, 3, sps2), xadj(l, j, k, 1&
   &             , sps2), xadjb(l, j, k, 1, sps2), xadj(l, j, k, 2, sps2), &
   &             xadjb(l, j, k, 2, sps2), xadj(l, j, k, 3, sps2), xadjb(l, &
   &             j, k, 3, sps2), xp, xpb, yp, ypb, zp, zpb, vp5, vp5b)
   CALL VOLPYM2_B(xadj(i, m, k, 1, sps2), xadjb(i, m, k, 1, sps2), xadj&
   &             (i, m, k, 2, sps2), xadjb(i, m, k, 2, sps2), xadj(i, m, k&
   &             , 3, sps2), xadjb(i, m, k, 3, sps2), xadj(i, m, n, 1, sps2&
   &             ), xadjb(i, m, n, 1, sps2), xadj(i, m, n, 2, sps2), xadjb(&
   &             i, m, n, 2, sps2), xadj(i, m, n, 3, sps2), xadjb(i, m, n, &
   &             3, sps2), xadj(l, m, n, 1, sps2), xadjb(l, m, n, 1, sps2)&
   &             , xadj(l, m, n, 2, sps2), xadjb(l, m, n, 2, sps2), xadj(l&
   &             , m, n, 3, sps2), xadjb(l, m, n, 3, sps2), xadj(l, m, k, 1&
   &             , sps2), xadjb(l, m, k, 1, sps2), xadj(l, m, k, 2, sps2), &
   &             xadjb(l, m, k, 2, sps2), xadj(l, m, k, 3, sps2), xadjb(l, &
   &             m, k, 3, sps2), xp, xpb, yp, ypb, zp, zpb, vp4, vp4b)
   CALL VOLPYM2_B(xadj(i, j, k, 1, sps2), xadjb(i, j, k, 1, sps2), xadj&
   &             (i, j, k, 2, sps2), xadjb(i, j, k, 2, sps2), xadj(i, j, k&
   &             , 3, sps2), xadjb(i, j, k, 3, sps2), xadj(l, j, k, 1, sps2&
   &             ), xadjb(l, j, k, 1, sps2), xadj(l, j, k, 2, sps2), xadjb(&
   &             l, j, k, 2, sps2), xadj(l, j, k, 3, sps2), xadjb(l, j, k, &
   &             3, sps2), xadj(l, j, n, 1, sps2), xadjb(l, j, n, 1, sps2)&
   &             , xadj(l, j, n, 2, sps2), xadjb(l, j, n, 2, sps2), xadj(l&
   &             , j, n, 3, sps2), xadjb(l, j, n, 3, sps2), xadj(i, j, n, 1&
   &             , sps2), xadjb(i, j, n, 1, sps2), xadj(i, j, n, 2, sps2), &
   &             xadjb(i, j, n, 2, sps2), xadj(i, j, n, 3, sps2), xadjb(i, &
   &             j, n, 3, sps2), xp, xpb, yp, ypb, zp, zpb, vp3, vp3b)
   CALL VOLPYM2_B(xadj(l, j, k, 1, sps2), xadjb(l, j, k, 1, sps2), xadj&
   &             (l, j, k, 2, sps2), xadjb(l, j, k, 2, sps2), xadj(l, j, k&
   &             , 3, sps2), xadjb(l, j, k, 3, sps2), xadj(l, m, k, 1, sps2&
   &             ), xadjb(l, m, k, 1, sps2), xadj(l, m, k, 2, sps2), xadjb(&
   &             l, m, k, 2, sps2), xadj(l, m, k, 3, sps2), xadjb(l, m, k, &
   &             3, sps2), xadj(l, m, n, 1, sps2), xadjb(l, m, n, 1, sps2)&
   &             , xadj(l, m, n, 2, sps2), xadjb(l, m, n, 2, sps2), xadj(l&
   &             , m, n, 3, sps2), xadjb(l, m, n, 3, sps2), xadj(l, j, n, 1&
   &             , sps2), xadjb(l, j, n, 1, sps2), xadj(l, j, n, 2, sps2), &
   &             xadjb(l, j, n, 2, sps2), xadj(l, j, n, 3, sps2), xadjb(l, &
   &             j, n, 3, sps2), xp, xpb, yp, ypb, zp, zpb, vp2, vp2b)
   CALL VOLPYM2_B(xadj(i, j, k, 1, sps2), xadjb(i, j, k, 1, sps2), xadj&
   &             (i, j, k, 2, sps2), xadjb(i, j, k, 2, sps2), xadj(i, j, k&
   &             , 3, sps2), xadjb(i, j, k, 3, sps2), xadj(i, j, n, 1, sps2&
   &             ), xadjb(i, j, n, 1, sps2), xadj(i, j, n, 2, sps2), xadjb(&
   &             i, j, n, 2, sps2), xadj(i, j, n, 3, sps2), xadjb(i, j, n, &
   &             3, sps2), xadj(i, m, n, 1, sps2), xadjb(i, m, n, 1, sps2)&
   &             , xadj(i, m, n, 2, sps2), xadjb(i, m, n, 2, sps2), xadj(i&
   &             , m, n, 3, sps2), xadjb(i, m, n, 3, sps2), xadj(i, m, k, 1&
   &             , sps2), xadjb(i, m, k, 1, sps2), xadj(i, m, k, 2, sps2), &
   &             xadjb(i, m, k, 2, sps2), xadj(i, m, k, 3, sps2), xadjb(i, &
   &             m, k, 3, sps2), xp, xpb, yp, ypb, zp, zpb, vp1, vp1b)
   tempb0 = eighth*zpb
