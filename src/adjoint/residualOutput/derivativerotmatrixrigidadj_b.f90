   ...
   !  
   !  Differentiation of derivativerotmatrixrigidadj in reverse (adjoint) mode:
   ...
   !      ******************************************************************
   !
   SUBROUTINE DERIVATIVEROTMATRIXRIGIDADJ_B(rotationmatrixadj, &
   ...
   END SUBROUTINE DERIVATIVEROTMATRIXRIGIDADJ_B
