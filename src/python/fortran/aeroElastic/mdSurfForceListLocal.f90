...
!      ******************************************************************
!
       subroutine mdCreateSurfForceListLocal(sps,famID,startInd,endInd)
!
!      ******************************************************************
!      *                                                                *
...
!
       ...
       if(.not. allocated(mdSurfForceLocal) ) then

         jj = mdNSurfNodesLocal(max(cgnsNfamilies,1_intType))
         allocate(mdSurfForceLocal(3,jj), stat=ierr)
         if(ierr /= 0)                             &
           call terminate("mdCreateSurfForceListLocal", &
                          "Memory allocation failure for &
                          &mdSurfForceLocal")
       endif

       mdSurfForceLocal(:,:) = forceLoc(:,:)
     ...
     end subroutine mdCreateSurfForceListLocal

!      ==================================================================

       subroutine mdDeleteSurfForceListLocal
!
!      ******************************************************************
!      *                                                                *
...
!
       ...
       if( allocated(mdSurfForceLocal) ) then

         deallocate(mdSurfForceLocal, stat=ierr)
         if(ierr /= 0)                             &
           call terminate("mdDeleteSurfForceListLocal", &
                          "Deallocation error for mdSurfForceLocal")
       endif

     end subroutine mdDeleteSurfForceListLocal
