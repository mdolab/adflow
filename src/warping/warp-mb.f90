      SUBROUTINE DELQ3DM (IL, JL, KL, I1, I2, J1, J2, K1, K2, XYZ0, S0,&
...
!     Finally, precise 1s for the three high-end faces:
      ...
      SUBROUTINE WARPBLK (IFACEPTB, IEDGEPTB, NCALL, IG, IGO, &
           IL, JL, KL, XYZ0, S0, DFACEI, DFACEJ, DFACEK, XYZ)
...
!         write(*,*) 'parameterizing'
         CALL PARAM3DM (IL, JL, KL, XYZ0, S0)
      END IF
...
!              ... and for Z perturbations:
      ...
      END SUBROUTINE WARPBLK

      SUBROUTINE WARPQ3DM (IL, JL, KL, I1, I2, J1, J2, K1, K2, XYZ0, S0,&
           DFACEI, DFACEJ, DFACEK, XYZ)
...
!     Actually, just set up the appropriate face perturbations.
      ...
      CALL DELQ3DM (IL, JL, KL, I1, I2, J1, J2, K1, K2, XYZ0, S0,&
                   DFACEI, DFACEJ, DFACEK, XYZ)
