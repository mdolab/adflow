...
ap_multi_bc = AeroProblem(
    ...
    evalFuncs=[
        ...
        "area_outflow",
        "mavgvx_outflow",
        "forcexpressure_outflow",
        "forcexmomentum_outflow",
        "mavgvi_outflow",
        "mdot_inflow1",
        "aavgptot_inflow1",
        "mavgttot_inflow1",
        ...
        "area_inflow1",
        "mavgvx_inflow1",
        "forcexpressure_inflow1",
        "forcexmomentum_inflow1",
        "mavgvi_inflow1",
        "mdot_inflow2",
        "aavgptot_inflow2",
        "mavgttot_inflow2",
        ...
        "area_inflow2",
        "mavgvx_inflow2",
        "forcexpressure_inflow2",
        "forcexmomentum_inflow2",
        "mavgvi_inflow2",
    ],
)
