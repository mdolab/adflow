...
METIS_DIR = $(SUMB_DIR)/src/metis-4.0
...
.SUFFIXES: .o .f .F .f90 .F90 .c .C .cc .cpp .h .hh .H .mod
...
FF90_LOCAL_FLAGS = -I$(SUMB_MODDIR) -I$(INPUT_DIR) -I$(TURB_DIR) -I$(SOLVER_DIR) -I$(SUMB_DIR)/src
...
CC_LOCAL_FLAGS   = -I$(SUMB_DIR)/src/c_defines -I.  -I$(METIS_DIR)
