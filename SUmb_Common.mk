...
WARPING_DIR = $(SUMB_DIR)/src/warping
...
FF90_LOCAL_FLAGS = $(COMMAND_SEARCH_PATH_MODULES)$(SUMB_MODDIR) \
		   ...
		   $(COMMAND_SEARCH_PATH_MODULES)$(WARPING_DIR)\
...
FF90_ADJOINT_FLAGS   = $(FF90_LOCAL_FLAGS) $(CGNS_INCLUDE_FLAGS) \
		   $(FF90_ADJ_FLAGS) $(ADDITIONAL_FF90_FLAGS) $(PV3_FLAGS) \
		   $(PETSC_INCLUDE_FLAGS) $(FF90_PRECISION_FLAGS)
